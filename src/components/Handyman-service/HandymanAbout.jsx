      ...
      px-10 md:px-20 py-16">
        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="space-y-6 text-[#5c4500] leading-relaxed text-lg">
            ...
            <p>
              KryossOne’s Handyman clone app is a complete solution for businesses to manage customer requests, assign tasks, track progress, and process payments seamlessly.
            </p>
