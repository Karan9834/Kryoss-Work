...
//         image: feedback1,
//         desc:
//             "M.R. Acharya from Nepal praises KryossOne for seamless service, fast support, and highly recommends us for online business solutions.",
//     },
//     {
//         name: "pablo",
//         image: feedback2,
...
//                         <span className="w-2 h-2 rounded-full bg-[#0b9f7a]"></span>
...
//                     Let's Check <span className="text-[#0b9f7a]">What Our Clients Love</span>{" "}
//                     to Share!
//                 </h2>
...
//                     <button className="rounded-full bg-[#0b9f7a] hover:bg-[#0b9f7a] text-white px-8 py-3 font-medium transition">
