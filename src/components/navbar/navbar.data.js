    ...
    products: [
        ...
        },
        {
            ...
            items: [
                ...
                { label: "Multi-Service Delivery App", subLabel: "Deliver anything from local stores", icon: "📦", href: "/products/delivery/multi-delivery" },
        ...
        },
        {
            ...
            items: [
                { label: "Handyman Service App", subLabel: "40+ On-demand Handyman service app", icon: "🛠️", href: "/products/home-service/handyman" },
                { label: "Home Cleaning Service", subLabel: "House cleaning booking platform", icon: "🧹", href: "/products/home-service/cleaning" },
                { label: "Tutor Booking App", subLabel: "Book tutors online instantly", icon: "🎓", href: "/products/home-service/tutor" },
                { label: "Salon & Beauty Booking App", subLabel: "App solution for salons and beauty experts", icon: "💇", href: "/products/home-service/salon" },
        ...
        },
        {
            ...
            items: [
                { label: "Dating App Like Tinder", subLabel: "On-demand dating and matchmaking app", icon: "❤️", href: "/products/social/dating-app" },
                { label: "Appointment Booking App", subLabel: "Online appointment scheduling for doctors", icon: "📅", href: "/products/social/appointment-booking" },
                { label: "Video App Like TikTok", subLabel: "Create a short-form video sharing platform", icon: "🎥", href: "/products/social/video-app" },
            ]
        }
    ],
    services: [
