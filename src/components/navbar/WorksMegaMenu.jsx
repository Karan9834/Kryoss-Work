...
const megaMenuData = [
  {
    ...
    accent: '#f97316',
    items: [
      { label: 'Websites Works', icon: '🌐', href: '/works/websites' },
      { label: 'UI/UX Design Works', icon: '✨', href: '/works/ui-ux' },
      { label: 'Graphic & Branding', icon: '🎨', href: '/works/branding' },
      { label: 'Social Media Creatives', icon: '📱', href: '/works/social-media' },
      { label: 'SAAS Works', icon: '☁️', href: '/works/saas' },
      { label: 'Real Estate Works', icon: '🏗️', href: '/works/real-estate' },
      { label: 'Business Works', icon: '💼', href: '/works/business' },
      { label: 'News & Magazine', icon: '📰', href: '/works/news-magazine' },
      { label: 'Finance Works', icon: '🏦', href: '/works/finance' },
      { label: 'On Demand Works', icon: '⚡', href: '/works/on-demand' },
    ],
  },
  {
    title: 'Applications Works',
    icon: '📱',
    accent: '#f97316',
    items: [
      { label: 'Health & Fitness Apps', icon: '🏋️', href: '/works/fitness-apps' },
      { label: 'Shopping Applications', icon: '🛍️', href: '/works/shopping-apps' },
      { label: 'Food & Grocery Delivery', icon: '🍔', href: '/works/food-grocery-apps' },
      { label: 'Entertainment & OTT', icon: '📺', href: '/works/ott-apps' },
      { label: 'Taxi & Logistics Apps', icon: '🚕', href: '/works/taxi-logistics' },
      { label: 'Tour & Travel Apps', icon: '✈️', href: '/works/travel-apps' },
      { label: 'Education Applications', icon: '🎓', href: '/works/education-apps' },
      { label: 'Matrimony Applications', icon: '💑', href: '/works/matrimony-apps' },
      { label: 'Social Networking Apps', icon: '💬', href: '/works/social-networking' },
      { label: 'Beauty & Salon Apps', icon: '💅', href: '/works/beauty-salon' },
    ],
  },
  {
    title: 'Gaming & Crypto',
    ...
    accent: '#f97316',
    items: [
      { label: 'Gaming Works', icon: '🕹️', href: '/works/gaming' },
      { label: 'Fantasy Apps', icon: '🏆', href: '/works/fantasy-apps' },
      { label: 'Crypto Apps', icon: '₿', href: '/works/crypto-apps' },
      { label: 'Exchange Apps', icon: '📊', href: '/works/exchange-apps' },
    ],
  },
  {
    title: 'Other Works',
    ...
    accent: '#f97316',
    items: [
      { label: 'Betting Apps', icon: '🎯', href: '/works/betting-apps' },
      { label: 'MLM Apps', icon: '🔗', href: '/works/mlm-apps' },
    ],
  },
];
...
/* ─────────────────────────────────────────────
   Scoped CSS (Consistent Design System)
───────────────────────────────────────────── */
const PMM_CSS = `
  .pmm-desktop {
  ...
  @keyframes pmmSpringIn {
    0%   { opacity: 0; transform: translateX(-70%) translateY(-10px) scale(0.97); }
    60%  { opacity: 1; transform: translateX(-70%) translateY(2px) scale(1.005); }
...
const WorksMegaMenu = ({ onLinkClick }) => (
  <>
    <style>{PMM_CSS}</style>
...
export const WorksMobileAccordion = ({ onLinkClick }) => (
