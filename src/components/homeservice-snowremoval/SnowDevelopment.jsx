        ...
        <section className="bg-white">
            ...
            <div className="max-w-7xl mx-auto px-6 pt-24 pb-14 text-center">
                ...
                <p className="text-gray-600 mt-6 max-w-4xl mx-auto text-base md:text-lg">
                    At KryossOne, we follow a streamlined, four-stage process to create your Uber Snow Plow Service App Solution. From gathering requirements to testing and launching, we ensure a seamless app development experience tailored to your business needs.
                </p>
