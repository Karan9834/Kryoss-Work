...
import Snowblog1 from "../../assets/homeservice-snow-img/Snowblog1.webp"
import Snowblog2 from "../../assets/homeservice-snow-img/Snowblog2.webp"
import Snowblog3 from "../../assets/homeservice-snow-img/Snowblog3.webp"


const blogs = [
    {
        id: 1,
        title: "How to Develop Uber Truck Delivery App For Startup Business?",
        image: Snowblog1
    },
    {
        id: 2,
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="text-center mb-14">
                    ...
                    <h2 className="text-4xl font-semibold text-gray-900">
                        Our <span className="text-sky-500">Related Blogs</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className="group border-2 border-blue-400 rounded-3xl p-5 hover:shadow-lg transition">
                        ...
                        <h3 className="mt-6 text-xl font-semibold text-gray-900 group-hover:text-sky-500 transition">
                            {blogs[0].title}
                        </h3>
                    </div>
                        ...
                        {blogs.slice(1).map((blog) => (
                            ...
                            >
                                ...
                                <div className="md:w-1/2 flex items-center">
                                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-sky-500 transition">
                                        {blog.title}
                                    </h3>
                                </div>
                            </div>
