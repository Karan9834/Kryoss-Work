        ...
        <section className="py-24 bg-white">
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <h2 className="text-center text-4xl font-semibold max-w-4xl mx-auto">
                    Targeted White Label Kotlin App Development{" "}
                ...
                <p className="text-center text-gray-600 max-w-4xl mx-auto mt-6">
                    We deliver specialized Kotlin Multiplatform solutions tailored to
                    different industries and business requirements.
                </p>
