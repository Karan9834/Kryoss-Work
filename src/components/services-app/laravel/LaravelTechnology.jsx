            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl font-semibold mb-4">
                        <span className="text-orange-400">Laravel Technology</span> Stack We Use
                    </h2>

                    <p className="text-white/80 max-w-3xl mx-auto leading-relaxed">
                        As a leading white label laravel development company, we use a modern
                        and scalable Laravel technology stack to build secure, high-performance,
                        and enterprise-ready applications for agencies and SaaS businesses.
                    </p>
