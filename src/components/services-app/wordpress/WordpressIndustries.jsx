            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-600 max-w-3xl mx-auto">
                        No matter what industry your client operates in - we've built for it. White Label Fox brings deep cross-industry WordPress experience so your agency can confidently take on any project, any niche, anywhere in the world.
                    </p>
