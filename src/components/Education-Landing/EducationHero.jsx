      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10 w-full pt-20">
        ...
        <div className="text-left space-y-8 animate-fadeInLeft">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <button className="px-10 py-4 bg-gradient-to-r from-indigo-600 to-teal-500 text-white font-bold rounded-full shadow-xl shadow-indigo-200 hover:scale-105 transition-all duration-300 flex items-center gap-2 group">
