...
const techLibrary = {
  ...
  css: { name: "CSS3", icon: "https://cdn.simpleicons.org/css3/1572B6" },
  ...
  // Cloud & DevOps
  aws: { name: "AWS", icon: "https://cdn.simpleicons.org/amazonaws/232F3E" },
  ...
  {description && (
    <p 
      className={`max-w-3xl mx-auto mb-14 ${
        isLightVariant ? 'text-gray-600' : 'text-white/80'
      }`}
    >
      {description}
    </p>
