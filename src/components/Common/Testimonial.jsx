  ...
  const testimonials = [
    {
      ...
      content: "This platform transformed our food delivery business. We've seen a 300% increase in orders within just 3 months of launch.",
      rating: 5,
      avatar: "https://images.unsplash.com/photo-1494790108777-466fd4c2437b?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80",
    },
    {
      name: "Michael Chen",
      role: "CEO, FreshMart",
      content: "The multi-vendor functionality is seamless. Our grocery marketplace now hosts 50+ vendors with zero technical issues.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Launched our taxi app in just 2 weeks. The real-time tracking and driver management features are exceptional.",
      rating: 5,
    ...
    },
    {
      name: "David Kim",
      role: "CTO, ShopEase",
      content: "Enterprise-grade security and 99.9% uptime. We process millions in transactions without any concerns.",
      rating: 5,
    ...
    },
    {
      ...
      content: "The analytics dashboard gives us incredible insights. We've optimized our operations and increased profits by 40%.",
      rating: 5,
    ...
    },
    {
      ...
      content: "Best decision we ever made. The support team is available 24/7 and helped us scale globally within months.",
      rating: 5,
...
const TestimonialCard = ({ testimonial, cardGradient }) => {
  return (
    ...
    >
      ...
      <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r ${cardGradient} rounded-t-2xl`}></div>
      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          <div className={`absolute inset-0 bg-gradient-to-r ${cardGradient} rounded-full blur-md opacity-50`}></div>
          <img
      ...
      <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${cardGradient} opacity-0 group-hover/card:opacity-100 transition-opacity duration-300 rounded-b-2xl`}></div>
    </motion.div>
  );
};
