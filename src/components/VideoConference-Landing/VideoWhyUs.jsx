            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-20 space-y-4">
                    <div className="flex items-center justify-center gap-2 mb-4">
                        ...
                        <span className="text-purple-400 font-bold text-sm uppercase tracking-widest">Why Choose Us</span>
                        <Star className="text-amber-400 fill-amber-400" size={16} />
                    </div>
                    <h2 className="text-3xl lg:text-4xl xl:text-5xl font-semibold text-white leading-tight mt-6">
                        The Gold Standard in <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-sky-400 to-pink-400">Virtual Communication.</span>
                    </h2>
                </div>
                        ...
                        >
                            ...
                            <div className="flex-1 text-center md:text-left space-y-4 relative z-10">
                                <div className="flex flex-col md:flex-row md:items-center gap-4">
                                    <h3 className="text-3xl font-semibold text-white group-hover:text-purple-300 transition-colors">{benefit.title}</h3>
                                    <span className={`w-fit mx-auto md:mx-0 px-4 py-1 rounded-full bg-gradient-to-r ${benefit.color} text-white font-bold text-[10px] uppercase tracking-widest shadow-lg shadow-purple-500/20 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-500`}>
                                        {benefit.stat}
                                    </span>
                                </div>
                            ...
                            <div className="hidden lg:flex w-24 h-24 shrink-0 items-center justify-center relative z-10 group-hover:translate-x-2 transition-transform duration-700">
                                <div className="text-6xl font-bold text-white/5 group-hover:text-purple-400/20 transition-colors">0{index + 1}</div>
                            </div>
                        </div>
                    ))}
                </div>
