      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-6xl mx-auto mb-12 sm:mb-16">
          ...
          <div className="inline-flex items-center gap-2 
                          ...
                          px-4 py-1.5 
                          rounded-full 
                          border border-[#b7d4f6] 
                          text-xs sm:text-sm 
                          text-gray-700 
                          mb-6">
            <span className="w-2.5 h-2.5 bg-blue-500 rounded-full"></span>
            About Uber for House Cleaning App
          </div>
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl 
            ...
            with Our Uber for House Cleaning App
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 
          ...
          <div className="flex justify-center md:justify-start">
            <img
              src="https://whitelabelfox.com/assets/images/uber-house-cleaning-app/fox-home-cleaning-about-us.webp"
              alt="Uber for House Cleaning App"
              className="w-full 
                         max-w-sm sm:max-w-md md:max-w-lg 
                         h-[350px] sm:h-[420px] md:h-full 
                         object-cover 
                         rounded-3xl 
                         shadow-xl"
            />
...
export default HomeCleaningAbout;