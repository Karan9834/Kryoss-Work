...
const HomeCleaningTestimonialsSection = () => {
  const testimonials = [
    {
      name: "Acharya",
      image: "https://whitelabelfox.com/assets/images/what-our-client-says/DP-Acharya.webp",
      desc: "M.R. Acharya from Nepal praises KryossOne for seamless service, fast support, and highly recommends us for online business solutions..",
    },
    {
      name: "pablo",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold">
            Let's Check <span className="text-[#55D7FF]"> What Our Clients Love to Share!</span>
          </h2>
        ...
        <div className="grid md:grid-cols-4 gap-8 relative">
          ...
          {testimonials.map((item, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-[#009ACA] mt-4">
                {item.name}
              </h3>
...
export default HomeCleaningTestimonialsSection;