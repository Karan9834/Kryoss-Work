    ...
    <section className="py-20 bg-white">
      <div className="max-w-8xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <div className="inline-flex items-center gap-2 border border-[#e68d08] 
                          text-black px-4 py-1.5 rounded-full text-sm mb-6">
            <span className="w-2 h-2 bg-[#ef7b0f] rounded-full"></span>
            Product Showcase
          </div>

          <h2 className="text-3xl md:text-5xl font-semibold">
            Explore  Our <span className="text-[#df870d]"> On-Demand App Solutions</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-[#ebac0f]">
                {product.title}
              </h3>
            </div>
          ))}
