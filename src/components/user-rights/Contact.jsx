      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 border border-gray-300 
            ...
            <span className="w-2 h-2 bg-gradient-to-r from-[#e89207] to-[#e38705] rounded-full"></span>
            Get Help
          </div>

          <h2 className="text-3xl md:text-5xl font-semibold">
            Contact <span className="bg-gradient-to-r from-[#da9a32] to-[#e07604] text-transparent bg-clip-text">Us</span> 
          </h2>
        </div>
