            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="text-center mb-14">
                    ...
                    <h2 className="text-4xl font-semibold text-gray-900">
                        Our <span className="text-violet-700">Related Blogs</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    {/* Left Big Blog */}
                    <div className="group border-2 border-violet-400 rounded-3xl p-5 hover:shadow-lg transition">
                        ...
                        <h3 className="mt-6 text-xl font-semibold text-gray-900 group-hover:text-violet-400 transition">
                            {blogs[0].title}
                        </h3>
                    </div>
                    ...
                    <div className="flex flex-col gap-10">
                        {blogs.slice(1).map((blog) => (
                            <div
                                key={blog.id}
                                className="group border-2 border-violet-400 rounded-3xl p-5 flex flex-col md:flex-row gap-6 hover:shadow-lg transition"
                            >
                                ...
                                <div className="md:w-1/2 flex items-center">
                                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-violet-400 transition">
                                        {blog.title}
                                    </h3>
                                </div>
                            </div>
