        ...
        <section className="w-full py-20 bg-white">
            <div className="max-w-5xl mx-auto px-4 text-center">
                ...
                <h2 className="text-4xl md:text-5xl font-semibold text-gray-900">
                    Stay Ahead with Our{" "}
                    <span className="text-violet-700">Latest Updates</span>
                </h2>
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <div className="relative w-full sm:w-[520px]">
                        <input
                            ...
                            className="w-full h-14 px-6 pr-36 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-violet-400"
                        />

                        <button className="absolute right-2 top-1/2 -translate-y-1/2 h-10 px-6 rounded-full bg-violet-400 text-white font-medium hover:bg-violet-600 transition">
                            Subscribe
                        </button>
                    </div>
                </div>
