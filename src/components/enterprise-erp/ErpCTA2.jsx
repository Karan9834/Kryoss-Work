            ...
            <div className="max-w-7xl mx-auto">
                <div className="bg-gradient-to-r from-blue-700 to-blue-900 rounded-[40px] px-8 md:px-16 py-16 flex flex-col lg:flex-row items-center gap-10 overflow-hidden relative group">
                    ...
                    <div className="lg:w-3/5 text-white relative z-10">
                        ...
                        <p className="text-[14px] md:text-[16px] font-normal leading-[1.6] text-blue-100/80 mb-10 max-w-xl">
                        ...
                        <div className="flex flex-wrap gap-5">
                            ...
                            <button className="px-10 py-4 bg-white text-blue-900 font-semibold text-[16px] tracking-[0.01em] rounded-full hover:bg-blue-50 transition shadow-xl">
                                Request Free Demo
                            </button>
                        </div>
                    </div>
