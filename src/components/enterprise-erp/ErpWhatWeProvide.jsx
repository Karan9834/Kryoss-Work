                ...
                <div className="flex flex-col md:flex-row gap-16 items-center bg-[#f7f7f7] rounded-[40px] px-8 md:px-12 pt-16 pb-0">
                    ...
                    <div className="md:w-1/2 pb-14 space-y-8">
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-transparent hover:border-blue-600 transition group">
                            ...
                            <h3 className="text-xl font-semibold mb-2 text-gray-900">Cloud Master Data</h3>
                            <p className="text-gray-500 text-sm leading-relaxed">Simplified centralized storage for all your critical enterprise records and transactions.</p>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-transparent hover:border-blue-600 transition group">
                            ...
                            <h3 className="text-xl font-semibold mb-2 text-gray-900">Native Mobility</h3>
                            <p className="text-gray-500 text-sm leading-relaxed">High performance mobile applications for your field workforce and management team.</p>
                        </div>
                    </div>
