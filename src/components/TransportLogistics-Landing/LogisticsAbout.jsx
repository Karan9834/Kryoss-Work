                    ...
                    <div className="space-y-10 order-1 lg:order-2">
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div className="space-y-4 p-6 bg-slate-50 rounded-[2rem] hover:bg-orange-50 transition-colors duration-500 group">
                                ...
                                <h3 className="font-bold text-[18px] md:text-[20px] leading-[1.3] text-[#0F172A]">Safe & Secure</h3>
                            ...
                            <div className="space-y-4 p-6 bg-slate-50 rounded-[2rem] hover:bg-blue-50 transition-colors duration-500 group">
                                ...
                                {/* Card Title - Updated: text-[18px] md:text-[20px] font-bold leading-[1.3] */}
                                <h3 className="font-bold text-[18px] md:text-[20px] leading-[1.3] text-[#0F172A]">Instant Tracking</h3>
                                {/* Card Description - Updated: text-[13px] md:text-[14px] font-normal leading-[1.6] */}
                                <p className="text-slate-500 text-[13px] md:text-[14px] font-normal leading-[1.6]">Real-time GPS visibility for every fleet member.</p>
                            </div>
                        </div>
                    </div>
