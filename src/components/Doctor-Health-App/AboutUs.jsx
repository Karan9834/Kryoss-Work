        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="flex items-center gap-2 mb-4">
              <span className="text-emerald-600 font-semibold text-sm tracking-wider uppercase">About Us</span>
            ...
            {/* Key features/stats - minimal */}
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div>
                <div className="text-3xl font-bold text-emerald-600">500+</div>
                <div className="text-sm text-gray-500 mt-1">Verified Specialists</div>
              </div>
              <div>
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md lg:max-w-lg">
              ...
              {/* Image container - clean, just a subtle shadow */}
              ...
              {/* Simple badge - optional, can remove if not wanted */}
