...
//                     Let's Check <span className="text-teal-400">What Our Clients Love</span>{" "}
//                     to Share!
//                 </h2>
...
//                     <button className="rounded-full bg-teal-400 hover:bg-teal-600 text-white px-8 py-3 font-medium transition">
