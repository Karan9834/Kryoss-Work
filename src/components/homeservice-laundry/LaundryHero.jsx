...
const LaundryHero = () => {
  return (
    <section className="relative w-full min-h-[80vh] bg-gradient-to-r from-[#003f3a] to-[#012f2b] overflow-hidden">
      ...
      shadow-[0_0_16px_rgba(20,184,166,0.85)]"
            >
            ...
            drop-shadow-[0_0_8px_rgba(20,184,166,0.9)]"
              >
                VYOM
              </span>

              <span className="text-white ml-1">LAUNDRY</span>
            </span>
          </div>

          {/* Heading */}
          <h1 className="text-4xl md:text-5xl font-semibold leading-tight mb-6">
            <span className="text-[#1dd3b0]">On Demand Laundry</span> App
            Development
          </h1>
