...
const BettingCardSection = () => {
    const products = [
        {
            title: "BetLab",
            desc: "A comprehensive sports betting solution offering a wide range of sports markets, real-time odds, and a seamless user experience.",
            image: "/Products/BetLab.jpg",
            link: "/products/betlab"
        },
        {
            title: "BetYourDuck",
            desc: "A next-generation betting exchange platform that allows users to bet against each other with liquid markets.",
            image: "/Products/Duck.jpg",
                        ...
                        <div key={index} className="text-center">
                            ...
                            >
                                <img
                                    src={product.image}
                                    alt={product.title}
                                    className="w-full rounded-xl border-[5px] border-transparent hover:border-emerald-500 transition duration-300 shadow-md group-hover:shadow-xl group-hover:scale-[1.03] object-contain"
                                />
                            </Link>
