...
export default function About() {
  return (
    <section
      id="about"
      className="relative py-24 bg-gradient-to-br from-white via-orange-50 to-blue-50 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              {pills.map((p) => (
                <div
                  key={p}
                  className="flex items-center gap-2 bg-orange-50 border border-orange-200 rounded-full px-4 py-1.5 hover:shadow-md hover:-translate-y-0.5 transition"
                >
                  <CheckCircle className="h-4 w-4 text-primary" />
                  <span className="text-sm font-medium text-foreground">{p}</span>
                </div>
            ...
            <a
              href="#contact"
              className="group inline-flex items-center gap-2 bg-primary text-white px-7 py-3.5 rounded-md font-semibold hover:bg-orange-600 transition-all shadow-lg shadow-orange-500/20"
            >
              About Us
          ...
          <div className="relative">
            ...
            {/* Decorative blobs */}
            <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-primary/10 rounded-full -z-10 animate-pulse" />
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-primary/5 rounded-full -z-10 animate-pulse" />
