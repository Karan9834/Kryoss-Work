...
const reasons = [
  ...
  },
  {
    image: "/whitelabel-assets/assets/images/why-choose/track-record.webp",
    fallback:
      "https://images.unsplash.com/photo-1551135049-8a33b5883817?w=400&q=80",
    title: "Proven Track Record",
    description:
      "250+ successfully delivered projects across 70+ countries speak to our reliability and commitment to excellence."
  },
...
export default function WhyChooseUs() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 right-10 w-72 h-72 bg-orange-200 rounded-full blur-3xl opacity-40 animate-pulse"></div>
