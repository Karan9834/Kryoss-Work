        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-6">
              {/* Card 1 - Products */}
              <div className="group h-full bg-white rounded-2xl border border-orange-100 p-6 shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer flex flex-col">
            ...
            <div className="flex flex-col gap-6">
              {/* Card 2 - Services */}
              <div className="group h-full bg-white rounded-2xl border border-amber-100 p-6 shadow-md hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer flex flex-col">
                ...
                <p className="text-gray-500 text-sm mb-4 leading-relaxed">
                  Check out our comprehensive service offerings and solutions benifits
                </p>
                <div className="flex items-center justify-between">
          ...
          <div className="lg:pl-4 h-full">
            <div className="h-full bg-gradient-to-br from-orange-100/50 to-amber-100/50 rounded-2xl p-8 border border-orange-200 shadow-lg backdrop-blur-sm flex flex-col justify-center">
