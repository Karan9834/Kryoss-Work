                ...
                <div className="grid lg:grid-cols-2 gap-20 items-center">
                    ...
                    <div className="space-y-8 order-1 lg:order-2">
                        <div className="space-y-4">
                            <span className="text-rose-600 font-bold text-sm uppercase tracking-[0.3em] block mb-2 px-3 py-1 bg-rose-50 w-max rounded-full border border-rose-100">
                                Scalable Operations
                            </span>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            {highlights.map((item, index) => (
                                <div key={index} className="flex flex-col gap-2 p-5 bg-orange-50/30 rounded-2xl shadow-sm border border-orange-100 hover:shadow-orange-100 hover:border-orange-200 transition-all duration-300 group hover:-translate-y-1">
                                    ...
                                    <h3 className="text-gray-800 font-bold mt-2">{item.title}</h3>
