...
const Hero = () => {
  return (
    <section
      className="relative w-full min-h-[450px] md:min-h-[600px] flex items-center justify-center overflow-hidden bg-[#0a0a0a]"
      style={{
        backgroundImage:
    ...
    >
      ...
      <div className="relative z-20 max-w-4xl mx-auto text-center px-6 py-20">
        ...
        <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-gray-200 mb-6 max-w-2xl mx-auto">
          Crafting Tomorrow's Digital Landscape
        </h2>

        <p className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed max-w-xl mx-auto mb-10">
        ...
        <Link to="/company/contact" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg shadow-orange-500/20 inline-block">
