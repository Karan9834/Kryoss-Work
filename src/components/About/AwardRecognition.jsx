    ...
    <section
      ...
      style={{
        background:
          ...
          "radial-gradient(50% 218% at 50% 50%, #251400 0%, #000000 100%)"
      }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-8xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold">
            Recognized by <span className="bg-orange-500 text-transparent bg-clip-text">Global Review Platforms & Industry Leaders</span>
          </h2>
