      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-5xl mx-auto">
            Our Managing Director & Founder shares the vision behind KryossOne—building
        ...
        <div className="grid md:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className=" font-medium mb-4">
              Managing Director & Founder @ KryossOne
            </p>

            {/* Quote */}
            <p className="italic text-gray-700 mb-6">
              “At KryossOne Pvt Ltd, our vision is to be the top remote tech
