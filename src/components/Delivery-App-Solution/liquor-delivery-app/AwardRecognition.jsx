      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-8xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold">
            Recognized by <span className="bg-gradient-to-r bg-gradient-to-r from-[#921E4B] to-[#4A011D] text-transparent bg-clip-text text-transparent bg-clip-text">Global Review Platforms & Industry Leaders</span>
          </h2>
