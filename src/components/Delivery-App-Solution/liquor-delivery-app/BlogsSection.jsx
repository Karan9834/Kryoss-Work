      ...
      <div className="max-w-7xl mx-auto px-6">
       ...
       <div className="flex justify-center mb-6">
        ...
        <h2 className="text-4xl font-semibold text-center mb-4 ">
          Our <span className="bg-gradient-to-r bg-gradient-to-r from-[#921E4B] to-[#4A011D] text-transparent bg-clip-text text-transparent bg-clip-text"> Related Blogs</span>
        </h2>
