    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <h2 className="text-center text-4xl font-bold mb-14">
          Inside Our Team:{" "}
          <span className="bg-gradient-to-r bg-gradient-to-r from-[#921E4B] to-[#4A011D] text-transparent bg-clip-text text-transparent bg-clip-text">Moments That Matter</span>
        </h2>
