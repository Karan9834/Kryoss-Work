    ...
    <section className="py-20 bg-white">
      <div className="max-w-8xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <div className="inline-flex items-center gap-2 border border-[#4A011D] 
...
Similar Delivery Clone App Solutions
          </div>

          <h2 className="text-3xl md:text-5xl font-semibold">
           Explore Our Other{" "}
            <span className="bg-gradient-to-r bg-gradient-to-r from-[#921E4B] to-[#4A011D] text-transparent bg-clip-text text-transparent bg-clip-text">
            On-Demand Delivery App Solutions
            </span>
          </h2>

          <p className="mt-4 text-gray-600 text-lg">
       In addition to our Alcohol Delivery App Clone Script, we offer ready-made solutions for various on-demand delivery services. Whether you're looking to launch a grocery, medicine, or even a fuel delivery app, we have the perfect clone app to meet your needs. Here’s a list of the delivery options we offer:
          </p>
