...
const Hero = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://whitelabelfox.com/assets/images/alcohol-delivery-app-solution/fox-alcohol-hero-section-bg.webp')",
      }}
    >
      <div className="max-w-8xl mx-auto px-6 md:px-10 py-20 md:py-10 flex flex-col-reverse md:flex-row items-center md:justify-between gap-10">
        ...
        <div className="md:w-1/2 flex flex-col justify-center text-center md:text-left">
          ...
          {/* Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-6 leading-snug text-black">
            <span className="bg-gradient-to-r from-[#921E4B] to-[#4A011D] bg-clip-text text-transparent">
              {" "}
              Launch Your Alcohol Delivery
            </span>
            Business with Our Clone App
          </h1>

          {/* Paragraph */}
          <p className="text-black text-base sm:text-lg md:text-lg mb-8 max-w-xl">
            Kickstart your online alcohol delivery business in just 5 days with
            our ready-to-launch Alcohol Delivery App Clone Script. Our solution
            offers a seamless platform for liquor delivery on Android and iOS,
            helping you quickly scale your business. Explore our live demo
            before you commit!{" "}
          </p>
          {/* linear-gradient(90deg, #850344 0%, #640233 102.98%); */}
          {/* Button */}
          <a
            href="https://preview.codecanyon.net/item/online-liquor-buying-android-app-ios-app-template-flutter-old-barrel/full_screen_preview/30024488"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-gradient-to-r from-[#850344] to-[#640233] px-6 sm:px-8 py-3 rounded-full text-white font-semibold text-base shadow-md hover:scale-105 transition duration-300 mx-auto md:mx-0 inline-block w-fit"
          >
            Live Demo →
          </a>
        </div>
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          <img
            src="https://whitelabelfox.com/assets/images/alcohol-delivery-app-solution/fox-alcohol-her-section-image.webp"
