                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8 animate-fade-in-left">
                        <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm border border-emerald-100">
                            ...
                            <span className="text-emerald-700 font-bold text-sm tracking-wide uppercase">On-Demand Solution</span>
                        </div>
                        ...
                        <p className="text-lg text-gray-600 max-w-xl leading-relaxed">
                            Empower your grocery business with our white-labeled, feature-rich on-demand
                            delivery application. Scalable, secure, and ready to launch.
                        </p>
