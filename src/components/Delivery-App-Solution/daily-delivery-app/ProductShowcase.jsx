      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold">
            Explore  Our <span className="bg-gradient-to-r from-[#003C52] to-[#01B49E] text-transparent bg-clip-text"> On-Demand App Solutions</span>
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold bg-gradient-to-r from-[#003C52] to-[#01B49E] text-transparent bg-clip-text">
                {product.title}
              </h3>
            </div>
          ))}
