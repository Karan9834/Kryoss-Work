...
const AwardRecognition = () => {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(94.55deg, #00222D 0.71%, #001015 100%)",
      }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-8xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold">
            Recognized by <span className="bg-gradient-to-r from-[#003C52] to-[#01B49E] text-transparent bg-clip-text">Global Review Platforms & Industry Leaders</span>
          </h2>
