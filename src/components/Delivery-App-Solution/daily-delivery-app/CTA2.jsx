        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl 
                           ...
                           leading-tight mb-5">
 Ready to Transform Your Milk Delivery Business?
            </h2>

            <p className="text-white/90 text-sm sm:text-base 
                          leading-relaxed mb-6 max-w-xl 
                          mx-auto md:mx-0">
             Streamline operations and offer exceptional service with our on-demand milk delivery solution. Start today and elevate your business to new heights!  </p>
          ...
          <div className="flex justify-center md:justify-end">
            <img
              src="https://whitelabelfox.com/assets/images/daily-delivery-app/fox-daily-delivery-cta-1.webp"
