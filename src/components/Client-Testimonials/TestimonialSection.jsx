...
const testimonials = [
  ...
  {
    name: "Mr. Tapiwa Shares His Experience with Kryoss Work | inDrive Clone App (Fox-Drive)",
    role: "Founder",
  ...
  {
    name: "Mr. Jacques Rocca Serra Shares His Honest Experience with Kryoss Work | Gojek Clone App",
    ...
    <section className="py-14 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <p className="text-gray-600 text-center max-w-4xl mx-auto mb-16">
          Hear from our clients about their journey with Kryoss Work.
