            ...
            <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-12 pt-10 pb-0 flex flex-col lg:flex-row lg:items-end justify-between">
                ...
                <div className="w-full lg:w-[50%] text-white pb-12 lg:pb-20 lg:pr-10">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#ffb347]">
                            🎓
                        </div>
                        <span className="text-[20px] font-bold tracking-wider lg:text-[22px]">
                            FOX-TUTOR
                        </span>
                    </div>
                    ...
                    <p className="text-gray-300 text-[16px] leading-[28px] max-w-xl mb-10">
                        ...
                        system. Simple and secure way to connect private tutors &
                        students on one platform with our on-demand tutor app.
                    </p>
