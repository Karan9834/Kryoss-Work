...
//                     Let's Check <span className="text-orange-500">What Our Clients Love</span>{" "}
//                     to Share!
//                 </h2>
...
//                     <button className="rounded-full bg-orange-500 hover:bg-orange-600 text-white px-8 py-3 font-medium transition">
