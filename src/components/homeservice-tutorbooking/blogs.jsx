...
import blog1 from "../../assets/homeservice-tutor-img/blog1.webp"
import blog2 from "../../assets/homeservice-tutor-img/blog2.webp"
import blog3 from "../../assets/homeservice-tutor-img/blog3.webp"
        ...
        <section className="w-full py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    {/* Left Big Blog */}
                    <div className="group border-2 border-orange-400 rounded-3xl p-5 hover:shadow-lg transition">
                    ...
                    <div className="flex flex-col gap-10">
                        {blogs.slice(1).map((blog) => (
                            <div
                                key={blog.id}
                                className="group border-2 border-orange-400 rounded-3xl p-5 flex flex-col md:flex-row gap-6 hover:shadow-lg transition"
                            >
