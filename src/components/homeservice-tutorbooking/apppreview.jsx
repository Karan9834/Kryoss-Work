...
const AppPreview = () => {
    ...
    const customerScreens = [
        { id: 1, title: "Dashboard", src: Tutorcustomer1 },
        { id: 2, title: "Expert Profile", src: Tutorcustomer2 },
        { id: 3, title: "Package Selection", src: Tutorcustomer3 },
        { id: 4, title: "Feedback", src: Tutorcustomer4 },
        { id: 5, title: "Visuals", src: Tutorcustomer5 },
        { id: 6, title: "Time Assignment", src: Tutorcustomer6 },
        { id: 7, title: "Final Payment", src: Tutorcustomer7 },
    ];

    const providerScreens = [
        { id: 1, title: "Account Settings", src: Tutorprovider1 },
        { id: 2, title: "Active Requests", src: Tutorprovider2 },
        { id: 3, title: "Assignment Details", src: Tutorprovider3 },
        { id: 4, title: "Session History", src: Tutorprovider4 },
        { id: 5, title: "Offerings", src: Tutorprovider5 },
        { id: 6, title: "Bundles", src: Tutorprovider6 },
        { id: 7, title: "Expert Overview", src: Tutorprovider7 },
    ];
            ...
            <div className="max-w-[1400px] mx-auto text-center">
                ...
                <div className="flex justify-center mb-8 px-4">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/20 bg-white/5 text-sm text-gray-300">
                        ...
                        Tutor Ecosystem Interface Preview
                    </div>
                </div>

                {/* Heading */}
                <h2 className="text-[32px] md:text-[45px] font-bold text-white leading-tight mb-6 max-w-5xl mx-auto px-4">
                    Visualize the <span className="text-[#f5b301]">Vyom Tutor Learner & Instructor</span> App Interface
                </h2>

                {/* Subtext */}
                <p className="text-gray-400 text-base md:text-lg mb-12 max-w-4xl mx-auto px-6">
                    Discover the sophisticated and user-centric design of our educational interfaces, crafted to optimize the instruction lifecycle for all participants.
                </p>
                                ...
                                <div className="relative rounded-[38px] overflow-hidden aspect-[9/19] bg-[#000]">
                                    {item.src ? (
                                        ...
                                        <div className="w-full h-full bg-gradient-to-b from-white/10 to-white/5 flex flex-col items-center justify-center text-white/20">
                                            ...
                                            <span className="text-[10px] uppercase tracking-[3px] font-bold px-4 text-center">{item.title}</span>
                                        </div>
                                    )}
