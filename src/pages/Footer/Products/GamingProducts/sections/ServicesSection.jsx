...
const services = [
  { id: 1, icon: <Gamepad2 />, title: "Casino Games", description: "Tailored Casino Games solution", color: "from-blue-500 to-purple-500", gradient: "from-blue-600 to-purple-600", bgGradient: "from-blue-50 to-purple-50", iconBg: "bg-gradient-to-br from-blue-500 to-purple-500", route: "/products/gaming/casino" },
  { id: 2, icon: <Trophy />, title: "Fantasy Sports", description: "Tailored Fantasy Sports solution", color: "from-blue-500 to-purple-500", gradient: "from-blue-600 to-purple-600", bgGradient: "from-blue-50 to-purple-50", iconBg: "bg-gradient-to-br from-blue-500 to-purple-500", route: "/products/gaming/fantasy-sports" }
];
...
const ServicesSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-red-50 via-white to-red-50 py-16 md:py-24 overflow-hidden">
