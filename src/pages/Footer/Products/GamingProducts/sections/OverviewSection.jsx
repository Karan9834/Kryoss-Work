...
import overview from '../../../../../assets/Games-Product/about.png'
...
const OverviewSection = ({
  ...
  return (
    <section className="relative w-full bg-gradient-to-br from-red-50 via-rose-50 to-white py-20 md:py-28 overflow-hidden">
