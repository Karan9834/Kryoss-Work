...
import { Sparkles, Dices, Network, ArrowRight } from 'lucide-react';

const services = [
  { id: 1, icon: <Sparkles />, title: "NFT Products", description: "Tailored NFT Products solution", color: "from-blue-500 to-purple-500", gradient: "from-blue-600 to-purple-600", bgGradient: "from-blue-50 to-purple-50", iconBg: "bg-gradient-to-br from-blue-500 to-purple-500", route: "/products/nft-marketplace" },
  { id: 2, icon: <Dices />, title: "Betting Apps", description: "Tailored Betting Apps solution", color: "from-blue-500 to-purple-500", gradient: "from-blue-600 to-purple-600", bgGradient: "from-blue-50 to-purple-50", iconBg: "bg-gradient-to-br from-blue-500 to-purple-500", route: "/products/betting-platform" },
  { id: 3, icon: <Network />, title: "MLM Products", description: "Tailored MLM Products solution", color: "from-blue-500 to-purple-500", gradient: "from-blue-600 to-purple-600", bgGradient: "from-blue-50 to-purple-50", iconBg: "bg-gradient-to-br from-blue-500 to-purple-500", route: "/products/mlm-software" }
];
...
const ServicesSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-teal-50 via-white to-teal-50 py-16 md:py-24 overflow-hidden">
