...
const ProsConsSection = ({
  badge = "⚖️ Niche Perspectives",
  title = "Pros & Cons of Other",
  highlight = "Products",
  ...
  return (
    <section className="bg-gradient-to-br from-emerald-900 via-teal-900 to-gray-900 py-16 md:py-20 overflow-hidden relative">
