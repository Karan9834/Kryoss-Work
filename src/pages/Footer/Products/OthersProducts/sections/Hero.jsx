...
import hero from '../../../../../assets/Products/prod1.png';
...
const Hero = ({
  ...
  bgGradient = "bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900",
  highlightGradient = "bg-gradient-to-r from-teal-400 to-emerald-500",
  badgeColor = "text-teal-400",
  buttonColor = "bg-gradient-to-r from-teal-500 to-emerald-600",
  glowColor = "bg-teal-500/20",
  particleColor1 = "bg-teal-400",
