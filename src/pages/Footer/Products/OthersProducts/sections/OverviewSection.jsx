...
import overview from '../../../../../assets/Products/over.png'
...
const OverviewSection = ({
  ...
  return (
    <section className="relative w-full bg-gradient-to-br from-teal-50 via-emerald-50 to-white py-12 md:py-16 overflow-hidden">
