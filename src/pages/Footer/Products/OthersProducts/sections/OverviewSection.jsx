...
import overview from '../../../../../assets/Products/prod2.png'
...
const OverviewSection = ({
  ...
  return (
    <section className="relative w-full bg-gradient-to-br from-teal-50 via-emerald-50 to-white py-20 md:py-28 overflow-hidden">
