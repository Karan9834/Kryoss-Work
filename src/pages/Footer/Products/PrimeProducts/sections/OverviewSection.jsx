...
import overview from '../../../../../assets/Products/snap.jpg'
...
const OverviewSection = ({
  ...
  return (
    <section className="relative w-full bg-gradient-to-br from-amber-50 via-orange-50 to-white py-12 md:py-16 overflow-hidden">
