...
import overview from '../../../../../assets/Products/prod4.png'
...
const OverviewSection = ({
  ...
  return (
    <section className="relative w-full bg-gradient-to-br from-amber-50 via-orange-50 to-white py-20 md:py-28 overflow-hidden">
