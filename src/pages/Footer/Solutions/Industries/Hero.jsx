...
import hero from '../../../../assets/yyy/Build Better Digital Solutio industries.jpg';
...
const Hero = ({
  ...
  highlightGradient = "bg-gradient-to-r from-orange-400 to-amber-500",
  badgeColor = "text-orange-400",
  buttonColor = "bg-gradient-to-r from-orange-500 to-amber-600",
  glowColor = "bg-orange-500/20",
  particleColor1 = "bg-orange-400",
  particleColor2 = "bg-amber-400"
}) => {
