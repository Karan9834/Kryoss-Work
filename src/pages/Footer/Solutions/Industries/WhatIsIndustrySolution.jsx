...
import overview from '../../../../assets/Indutries/over.jpeg'
...
const WhatIsIndustrySolution = ({
  ...
  return (
    <section className="relative w-full bg-gradient-to-br from-orange-50 via-amber-50 to-white py-12 md:py-16 overflow-hidden">
