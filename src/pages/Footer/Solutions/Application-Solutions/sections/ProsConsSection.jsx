      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-10 md:mb-12">
          ...
          <h2 className="text-[1.875rem] md:text-[2.25rem] font-bold text-white mb-3">
            Pros & Cons of <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">Start-ups</span>
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-sm md:text-base font-normal">
            Understanding both sides before taking the entrepreneurial leap
          </p>
        </div>
