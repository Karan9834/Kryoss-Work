...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden py-20 md:py-28">
        ...
        <div className="grid md:grid-cols-2 items-center gap-12 lg:gap-16">
          ...
          <div className="max-w-xl text-center md:text-left">
            ...
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
              <span className="text-xs font-normal text-cyan-400 tracking-wide">
            ...
            <p className="mt-5 text-base font-normal text-gray-300 leading-relaxed">
              Transform your business with cutting-edge application solutions.
              We deliver scalable, secure, and innovative software tailored to your needs.
            </p>

            {/* CTA Buttons - Size: 16px, Weight: 600 */}
            <div className="mt-7 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              
              <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-full font-semibold text-base shadow-lg hover:shadow-cyan-500/30 transition-all duration-300 hover:scale-105">
                Get Started →
              </button>
          ...
          <div className="relative flex justify-center md:justify-end">
            ...
            {/* Glow effect */}
            <div className="absolute w-[280px] h-[280px] bg-cyan-500/20 rounded-full blur-3xl"></div>
            
            {/* Decorative circles */}
            <div className="absolute -top-6 -right-6 w-24 h-24 bg-cyan-500/20 rounded-full blur-xl"></div>
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-blue-600/20 rounded-full blur-xl"></div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-1.5 h-1.5 bg-cyan-400 rounded-full animate-float opacity-60"></div>
        <div className="absolute top-3/4 right-1/4 w-2 h-2 bg-blue-400 rounded-full animate-float-delay opacity-60"></div>
        <div className="absolute bottom-1/3 left-1/3 w-1 h-1 bg-white rounded-full animate-float-slow opacity-40"></div>
        <div className="absolute top-1/2 right-1/3 w-1.5 h-1.5 bg-cyan-300 rounded-full animate-float opacity-50"></div>
      </div>
