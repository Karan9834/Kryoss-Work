        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <h2 className="text-[1.875rem] md:text-[2.25rem] font-bold text-gray-900 mb-4">
              A Snapshot of <span className="text-purple-700">Start-ups</span>
            </h2>
            
            {/* Description */}
            <div className="space-y-4 mt-6">
              <p className="text-sm md:text-base font-normal text-gray-800 leading-relaxed">
                Start-ups represent entrepreneurial ventures focused on delivering specific products or services 
                that solve authentic market challenges. These enterprises typically launch with limited capital and 
                flexible operational approaches.
              </p>
              
              <p className="text-sm md:text-base font-normal text-gray-800 leading-relaxed">
                During early stages, founders primarily self-fund operations before approaching family circles, 
                professional networks, angel investors, or venture capital firms for external financing. While 
                creativity powers start-up momentum, sustained success hinges on scaling capabilities, 
                regulatory compliance, and precise implementation.
              </p>
            </div>
            
            {/* Key Stats with glassy cards */}
            <div className="mt-8 flex flex-wrap gap-4">
              <div className="flex items-center gap-2 bg-white/40 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-200/50 shadow-sm">
                <div className="w-6 h-6 rounded-full bg-purple-100 flex items-center justify-center">
                  <svg className="w-3 h-3 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                </div>
                <span className="text-sm font-medium text-gray-700">Bootstrapped Friendly</span>
              </div>
              <div className="flex items-center gap-2 bg-white/40 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-200/50 shadow-sm">
                <div className="w-6 h-6 rounded-full bg-purple-100 flex items-center justify-center">
                  <svg className="w-3 h-3 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-sm font-medium text-gray-700">Investor Ready</span>
              </div>
              <div className="flex items-center gap-2 bg-white/40 backdrop-blur-sm rounded-full px-4 py-2 border border-purple-200/50 shadow-sm">
                <div className="w-6 h-6 rounded-full bg-purple-100 flex items-center justify-center">
                  <svg className="w-3 h-3 text-purple-600" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="relative bg-white/40 backdrop-blur-md rounded-2xl p-5 shadow-2xl border border-white/60">
              ...
              <div className="absolute bottom-6 left-6 bg-white/95 backdrop-blur-md rounded-lg px-4 py-2 shadow-xl border border-purple-200/80">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-gray-700">Active Start-ups</span>
                  <span className="text-xs font-bold text-purple-700">50,000+</span>
                </div>
              </div>
