...
import { ArrowRight, Play, CheckCircle, Zap, Clock, Smartphone } from 'lucide-react';
import heroImage from "../../../../assets/On-Demand/hero.png"; // Update with your image path

const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-blue-600 via-cyan-700 to-teal-800 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-1/4 w-2 h-2 bg-blue-300 rounded-full animate-float opacity-70"></div>
        <div className="absolute top-40 right-1/3 w-3 h-3 bg-cyan-400 rounded-full animate-float-delay opacity-60"></div>
        <div className="absolute bottom-32 left-1/3 w-2 h-2 bg-teal-400 rounded-full animate-float-slow opacity-50"></div>
        <div className="absolute top-1/2 right-1/4 w-1.5 h-1.5 bg-blue-200 rounded-full animate-float opacity-40"></div>
        <div className="absolute bottom-1/4 right-1/2 w-2.5 h-2.5 bg-cyan-300 rounded-full animate-float-delay opacity-60"></div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-5">
              <span className="text-xs font-normal text-blue-200 tracking-wide">
                ⚡ On-Demand Solutions
              </span>
            </div>
            ...
            {/* Description */}
            <p className="text-base font-normal text-blue-100/90 leading-relaxed mb-6 max-w-lg mx-auto md:mx-0">
              Launch your on-demand platform with our ready-to-deploy solutions. From ride-hailing to food delivery, 
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <button className="group relative px-8 py-3.5 bg-gradient-to-r from-blue-500 to-cyan-600 text-white font-semibold text-base rounded-full shadow-lg hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 overflow-hidden">
            ...
            <div className="mt-8 pt-5 border-t border-white/20">
              <div className="flex flex-wrap gap-6 justify-center md:justify-start">
                <div className="text-center md:text-left">
                  ...
                  <div className="text-xs font-normal text-blue-200/80 mt-1">Businesses Launched</div>
                </div>
                <div className="text-center md:text-left">
                  <div className="text-xl font-bold text-white">99.9%</div>
                  <div className="text-xs font-normal text-blue-200/80 mt-1">Uptime Guarantee</div>
                </div>
                <div className="text-center md:text-left">
                  <div className="text-xl font-bold text-white">2M+</div>
                  <div className="text-xs font-normal text-blue-200/80 mt-1">Active Users</div>
                </div>
              </div>
            </div>
          ...
          <div className="relative flex justify-center md:justify-end">
            ...
            <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-4 shadow-2xl border border-white/20">
              ...
              {/* Overlay gradient */}
              <div className="absolute inset-4 rounded-xl bg-gradient-to-t from-blue-600/20 via-transparent to-transparent pointer-events-none"></div>
              
              {/* Floating badge 1 */}
              <div className="absolute bottom-6 left-6 bg-black/50 backdrop-blur-md rounded-lg px-3 py-1.5 border border-blue-500/30">
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-xs font-normal text-white">Live Platform</span>
                  <span className="text-xs font-bold text-blue-400">Active</span>
                </div>
              </div>
              
              {/* Floating badge 2 */}
              <div className="absolute top-6 right-6 bg-blue-500/90 backdrop-blur-md rounded-lg px-3 py-1.5 shadow-lg">
                <span className="text-xs font-normal text-white">🚀 Launch Ready</span>
              </div>
