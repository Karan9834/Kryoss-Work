                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                Finance & BFSI <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500">App Development</span>
                            </motion.h1>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <img
                                ...
                                className="relative w-full rounded-2xl shadow-xl object-cover h-[400px]"
                            />
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-semibold mb-1">Security Standard</p>
                                        <p className="text-2xl font-bold text-gray-900">PCI-DSS Tier 1</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
