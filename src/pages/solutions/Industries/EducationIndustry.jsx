...
import {
    ChevronRight, CheckCircle, BookOpen, GraduationCap, Users, MonitorPlay,
...
const EducationIndustry = () => {
    ...
    const panelFeatures = {
        "LMS Platform": {
            ...
            features: [
                ...
                "Performance Reports", "Gamification"
            ]
        },
        "School Mgmt": {
            icon: BookOpen,
            ...
            features: [
                ...
                "Attendance Automation", "Examination Management"
            ]
        },
        "E-Learning App": {
            icon: Smartphone,
            ...
            features: [
                ...
                "Live Classes", "Push Notifications"
            ]
        },
        "Online Tutoring": {
            icon: Users,
    ...
    const commonFeatures = [
        { icon: RefreshCw, title: "Change/Cancel Courses", desc: "Easily modify or drop enrolled courses anytime." },
        { icon: Clock, title: "Schedule Classes", desc: "Schedule live classes and set reminders in advance." },
        { icon: CreditCard, title: "Payment Modes", desc: "Digital wallets, cards, and secure online payment methods." },
        { icon: MapPin, title: "Location Tracking", desc: "Real-time GPS tracking to monitor school buses." },
        { icon: Phone, title: "Talk To Tutors", desc: "Communicate through the app without sharing numbers." },
        { icon: Bell, title: "Push Notification", desc: "Receive real-time alerts for assignments and classes." }
    ];

    const advanceFeatures = [
        { icon: CreditCard, title: "In-App Wallet", desc: "Secure in-app wallet for fast fee payments and purchases." },
        { icon: Bell, title: "Emergency System", desc: "Integrated SOS button and emergency alerts for parents." },
        { icon: Zap, title: "Smart Allocation", desc: "Auto-assigns resources and classrooms to cut management time." },
        { icon: Star, title: "Scholarship Programs", desc: "Reward performing students with points or scholarships." },
        { icon: MapPin, title: "Performance Heat Map", desc: "See areas with maximum engagement to optimize curriculum." },
        { icon: BarChart, title: "Academic Analytics", desc: "Comprehensive dashboard to track student growth and metrics." }
    ];
    ...
    const solutions = [
        { icon: Settings, title: "Fully Customizable", desc: "Our Education Scripts are flexible enough to meet the specific needs of institutions." },
        { icon: Server, title: "Cloud Deployment", desc: "Portals and LMS will work smoothly on scalable cloud infrastructure." },
        { icon: CreditCard, title: "Easy Payments", desc: "Our solutions support multiple payment APIs with easy integration." },
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                ...
                                <span className="text-sm font-semibold text-gray-700">EdTech Solution Available</span>
                            </motion.div>
                            ...
                            >
                                Education App <br /> <span className="text-[30px] md:text-[48px] lg:text-[60px] font-bold leading-[1.2] tracking-[-0.02em] text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500">Development</span>
                            </motion.h1>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-semibold mb-1">Student Retention</p>
                        ...
                        <div className="w-full lg:w-1/2">
                            <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-gray-900 mb-6">
                                Insightful Learning <span className="text-orange-500">Management</span>
                            </h2>
                            <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-600 mb-6 max-w-lg">
                                Streamline learning and development and convert instructor-led training into a cloud-based, configurable learning management system to support educators, teachers, and learners alike.
                            </p>
                            <ul className="space-y-4 mb-8">
                                {[
                                    "Track impact of learning",
                                    "Compare training goals",
                                    "Scale your learning operations",
                                    "Organize internal and external activities"
                                ].map((item, i) => (
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-slate-500 mt-4 max-w-2xl mx-auto">
                            Complete solutions with dedicated panels ensuring flawless educational operations
                        </p>
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
                        ...
                        <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-500 max-w-2xl mx-auto">
                            Our solution guarantees power, stability, and lifetime value packed with extraordinary integrations for educational institutions.
                        </p>
                    </div>
                        ...
                        <div className="w-full lg:w-2/5 relative group">
                            <div className="relative h-full min-h-[400px] lg:min-h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md rounded-2xl p-4 shadow-lg z-20 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="font-bold text-gray-900">Complete Automation</p>
