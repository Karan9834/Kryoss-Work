...
const LogisticsIndustry = () => {
    ...
    const panelFeatures = {
        "Client App": {
            icon: Package,
            image: "/SolIndus/Logistics2.png",
            features: [
                "Easy Registration", "Live Tracking", "Schedule Pickup",
                "Freight Estimation", "Multiple Payment Gateways", "Order History",
                "Notifications & Alerts", "Feedback & Ratings"
            ]
        },
        "Driver App": {
            icon: Truck,
            image: "/SolIndus/Logistics3.png",
            features: [
                "Profile Management", "Route Optimization", "Delivery Proof (e-Sign)",
                "Pick-up Management", "Accept/Decline Requests", "Earnings Tracker",
                "In-app Navigation", "Contact Dispatcher"
            ]
        },
        "Admin Panel": {
            icon: Shield,
            image: "/SolIndus/Logistics4.png",
            features: [
                "Dashboard Overview", "Fleet Management", "Driver Management",
                "Order Management", "Billing & Invoice", "Performance Analytics",
                "Vehicle Tracking", "Role-based Control"
            ]
        }
    };

    const commonFeatures = [
        { icon: MapPin, title: "Real-Time Location", desc: "Inspect and track every delivery live to prevent delays." },
        { icon: Truck, title: "Fleet Management", desc: "Easily manage your entire fleet with our scalable solutions." },
        { icon: Navigation, title: "Dispatch & Delivery", desc: "Witness on-time dispatch with state-of-the-art solutions." },
        { icon: Archive, title: "Warehouse Management", desc: "Save on unwanted storage expense and boost efficiency." },
        { icon: Code, title: "Automation", desc: "Automated functionality right from pick-up till delivery." },
        { icon: Clock, title: "On-Time Tracking", desc: "Automatic system assignment to drivers for on-time drops." }
    ];

    const advanceFeatures = [
        { icon: Route, title: "Route Optimization", desc: "Smart algorithms to suggest the most fuel-efficient paths." },
        { icon: BarChart, title: "Freight Management", desc: "Right platform to help manage and grow your freight business." },
        { icon: Ship, title: "Transport Mobility", desc: "Centralize all mobility services and reduce unwanted costs." },
        { icon: FileText, title: "Custom Reporting", desc: "Detailed breakdown of operational and financial metrics." },
        { icon: Shield, title: "God's Eye View", desc: "Overall top-level view of all operational fleets on a single map." },
        { icon: Zap, title: "IoT Integration", desc: "Sync with IoT sensors for temperature or load monitoring." }
    ];
                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                Logistics <br /> <span className="text-[30px] md:text-[48px] lg:text-[60px] font-bold leading-[1.2] tracking-[-0.02em] text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500">App Development</span>
                            </motion.h1>
                            ...
                            >
                                Enhance the productivity of your Logistics business with transport & Logistics apps that drive all the operations efficiently.
                            </motion.p>
                        ...
                        <div className="w-full lg:w-[55%] relative flex justify-center">
                            ...
                            >
                                ...
                                <img
                                    src="/SolIndus/Logistics.png"
                                    alt="Logistics App Development"
                                    width="2048"
                                    height="1365"
                                    className="max-w-full max-h-full object-contain"
                                    onError={(e) => { e.target.src = '/SolIndus/Logistics.png'; }}
                                />
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-semibold mb-1">Deliveries Optimization</p>
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-600 mb-6 max-w-lg">
                                Our cloud-based managed logistics mobile app helps you to collaborate easily and focus on your business to achieve higher productivity and precision.
                            </p>
                            <ul className="space-y-4 mb-8">
                                {[
                                    "Centralized Freight Management",
                                    "Real-time Tracking and Syncs",
                                    "Hardware-Free Cloud Deployments",
                                    "IoT and Analytics Readines"
                                ].map((item, i) => (
