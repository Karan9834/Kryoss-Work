...
const HealthcareIndustry = () => {
  ...
  const commonFeatures = [
    {
      ...
      desc: "Easily modify or cancel your medical appointments anytime.",
    },
    {
      icon: Clock,
      title: "Schedule Consults",
      desc: "Schedule doctor consults for a later date and time.",
    },
    {
      icon: CreditCard,
      title: "Payment Modes",
      desc: "Digital wallets, cards, and secure online payment methods.",
    },
    {
      icon: MapPin,
      title: "Live Order Tracking",
      desc: "Real-time tracking to monitor pharmacy deliveries.",
    },
    {
      icon: Phone,
      title: "Talk To Your Doctor",
      desc: "Communicate securely through the app without sharing personal numbers.",
    },
    {
      icon: Bell,
      title: "Push Notification",
      desc: "Receive real-time alerts for appointments and health updates.",
    },
  ];
  ...
  const advanceFeatures = [
    {
      icon: CreditCard,
      title: "Health Wallet",
      desc: "Secure in-app wallet for fast, cashless medical transactions.",
    },
    {
      icon: Shield,
      title: "SOS/Emergency Button",
      desc: "Integrated SOS button for immediate medical assistance.",
    },
    {
      icon: Zap,
      title: "Smart Doctor Assignment",
      desc: "Auto-assigns the nearest available specialist for urgent care.",
    },
    {
      icon: Star,
      title: "Wellness Programs",
      desc: "Reward consistent health routines with wellness points.",
    },
    {
      icon: MapPin,
      title: "Epidemic Tracker",
      desc: "Track regional health data and disease spread.",
    },
    {
      icon: BarChart,
      title: "Health Analytics",
      desc: "Comprehensive dashboard to track personal health metrics.",
    },
  ];
  ...
  const solutions = [
    ...
    },
    {
      icon: CheckCircle,
      title: "Bug Support",
      desc: "Report issues and get free support/updates for the first year of operation.",
      details: [
    ...
    },
    {
      ...
      desc: "One-off payment for lifetime software usage and domain license with no recurring fees.",
      details: [
        "No hidden costs",
        "Perpetual updates",
    ...
    },
    {
      ...
      desc: "Smooth configuration on open-source Linux servers by our expert deployment team.",
      details: ["Optimized performance", "Secure setup", "Automated backups"],
    },
    {
      icon: Database,
      title: "Open Source DB",
      desc: "Secure MySQL database usage with minimal renewal costs and maximum reliability.",
      details: ["Data encryption", "Scalable architecture", "Easy migration"],
    },
    {
      icon: CreditCard,
      title: "Global Payments",
      desc: "Support for international payment gateways and easy API integration for seamless transactions.",
      details: ["Multiple currencies", "PCI compliant", "Fraud protection"],
    },
  ];
  ...
  return (
    <div className="w-full bg-white relative font-sans overflow-hidden">
      <Helmet>
        ...
        <meta
          name="description"
          content="KRYOSS Is Yours Healthcare App Development Company for Healthcare Industry. Build smart solutions to improve medical care."
        />
      </Helmet>
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              >
                ...
                <span className="text-sm font-semibold text-gray-700">
                  Healthcare Solutions Available
                </span>
              </motion.div>
            ...
            <div className="w-full lg:w-[55%] relative flex justify-center">
              ...
              >
                ...
                <img
                  ...
                  onError={(e) => {
                    e.target.src = "/SolIndus/Health.png";
                  }}
                />
              </motion.div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-gray-900 mb-6">
                Why Kryoss Softech For{" "}
                <span className="text-orange-500">Healthcare</span> Services?
              </h2>
              <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-600 mb-6 max-w-lg">
                We provide reliable healthcare application development services
                with faster response times and better return on investment. Our
                teams deliver innovative, best-in-class results customized to
                your requirements.
              </p>
              ...
              <Link
                to="/company/contact"
                className="px-8 py-4 bg-gray-900 text-white rounded-xl font-semibold hover:bg-orange-500 transition-all shadow-md"
              >
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {(activeFeatureTab === "Common"
                ...
                <div
                  key={idx}
                  className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 p-8 rounded-2xl hover:bg-slate-800 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-orange-500/30 group"
                >
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
            ...
            <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-500 max-w-2xl mx-auto">
              ...
              packed with extraordinary integrations tailored to pharmaceutical
              sectors.
            </p>
          </div>

          <div className="flex flex-col lg:flex-row gap-12 xl:gap-16 items-start">
            <div className="w-full lg:w-2/5 relative group sticky top-8">
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h4 className="text-[16px] lg:text-[18px] font-semibold leading-[1.4] text-gray-900 mb-2">
                            {sol.title}
                          </h4>
