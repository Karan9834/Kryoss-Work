...
import {
    ChevronRight, CheckCircle, Activity, User, Shield, Stethoscope,
    ...
    UserCheck, Phone, LayoutDashboard, ArrowRight, HeartPulse
} from 'lucide-react';
...
const HealthcareIndustry = () => {
    ...
    const panelFeatures = {
        "Appointment Apps": {
            ...
            features: [
                "Easy Registration & Sign-In", "Search Top Doctors", "Book Appointments",
                "Push Notifications", "Ratings & Reviews", "Telemedicine Ready",
                "Secure Payments", "Medical Records"
            ]
        },
        "Pharmacy Apps": {
            icon: HeartPulse,
            ...
            features: [
                "Search Medicines", "Upload Prescription", "Cart Management",
                "Order Tracking", "Payment Gateways", "Offers & Discounts",
                "Refill Reminders", "Customer Support"
            ]
        },
        "Telemedicine Apps": {
            icon: Smartphone,
            ...
            features: [
                "Video Consultations", "Chat with Doctors", "E-Prescriptions",
                "Symptom Checker", "Health Tracking", "Patient History",
                "Multi-lingual Support", "Data Encryption"
            ]
        },
        "Fitness Apps": {
            icon: Activity,
            ...
            features: [
                "Workout Plans", "Diet Tracking", "Step Counter",
                "Heart Rate Monitor", "Goal Setting", "Community Forum",
                "Wearable Integration", "Progress Analytics"
            ]
        }
    };

    const commonFeatures = [
        { icon: RefreshCw, title: "Change/Cancel Appointment", desc: "Easily modify or cancel your medical appointments anytime." },
        { icon: Clock, title: "Schedule Consults", desc: "Schedule doctor consults for a later date and time." },
        { icon: CreditCard, title: "Payment Modes", desc: "Digital wallets, cards, and secure online payment methods." },
        { icon: MapPin, title: "Live Order Tracking", desc: "Real-time tracking to monitor pharmacy deliveries." },
        { icon: Phone, title: "Talk To Your Doctor", desc: "Communicate securely through the app without sharing personal numbers." },
        { icon: Bell, title: "Push Notification", desc: "Receive real-time alerts for appointments and health updates." }
    ];

    const advanceFeatures = [
        { icon: CreditCard, title: "Health Wallet", desc: "Secure in-app wallet for fast, cashless medical transactions." },
        { icon: Shield, title: "SOS/Emergency Button", desc: "Integrated SOS button for immediate medical assistance." },
        { icon: Zap, title: "Smart Doctor Assignment", desc: "Auto-assigns the nearest available specialist for urgent care." },
        { icon: Star, title: "Wellness Programs", desc: "Reward consistent health routines with wellness points." },
        { icon: MapPin, title: "Epidemic Tracker", desc: "Track regional health data and disease spread." },
        { icon: BarChart, title: "Health Analytics", desc: "Comprehensive dashboard to track personal health metrics." }
    ];
    ...
    const solutions = [
        { icon: Shield, title: "HIPAA Compliant", desc: "Deep understanding of FDA, HIPAA, HITECH Acts to deliver secure solutions." },
        { icon: Zap, title: "Agile Approach", desc: "Rapid project delivery with seamless communication between all stakeholders." },
        { icon: Headphones, title: "24*7 Support", desc: "Availability of assistance as per the client time zone and post-deployment support." },
        { icon: LayoutDashboard, title: "CoE Delivery", desc: "Centers of Excellence to facilitate cutting-edge technological solutions." }
    ];

    return (
        <div className="w-full bg-white relative font-sans overflow-hidden">
            <Helmet>
                <title>Healthcare App Development Services | KryossWork</title>
                <meta name="description" content="KRYOSS Is Yours Healthcare App Development Company for Healthcare Industry. Build smart solutions to improve medical care." />
            </Helmet>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                ...
                                <span className="text-sm font-semibold text-gray-700">Healthcare Solutions Available</span>
                            </motion.div>
                            ...
                            >
                                Healthcare <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500">App Development</span>
                            </motion.h1>
                            ...
                            >
                                The smart solutions to help improve and automate patient services and promote efficient Medical Care. Save patients’ and doctors’ time with modern mobile healthcare apps.
                            </motion.p>
                        ...
                        <div className="w-full lg:w-[55%] relative flex justify-center">
                            ...
                            >
                                ...
                                <img
                                    ...
                                    onError={(e) => { e.target.src = '/SolIndus/Health.png'; }}
                                />
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-semibold mb-1">Efficiency Increased</p>
                        ...
                        <div className="w-full lg:w-1/2">
                            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                                Why Kryoss Softech For <span className="text-orange-500">Healthcare</span> Services?
                            </h2>
                            <p className="text-gray-600 mb-6 text-base font-semibold leading-relaxed max-w-lg">
                                We provide reliable healthcare application development services with faster response times and better return on investment. Our teams deliver innovative, best-in-class results customized to your requirements.
                            </p>
                            <ul className="space-y-4 mb-8">
                                {[
                                    "Faster response times",
                                    "Better return on investment",
                                    "Well-trained healthcare developers",
                                    "Customized innovative requirements"
                                ].map((item, i) => (
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-slate-900">
                            Our <span className="bg-gradient-to-r from-orange-600 to-slate-800 bg-clip-text text-transparent">
                                Proficiency
                            </span> in Healthcare
                        </h2>
                        <p className="text-slate-500 mt-4 max-w-2xl mx-auto">
                            We offer impeccable health app solutions and services from doctor’s appointment to medication tracking and everything in between.
                        </p>
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
                        ...
                        <p className="text-gray-500 text-lg md:text-xl max-w-2xl mx-auto">
                            Our solution guarantees power, stability, and lifetime value packed with extraordinary integrations tailored to pharmaceutical sectors.
                        </p>
                    </div>
                        ...
                        <div className="w-full lg:w-2/5 relative group">
                            <div className="relative h-full min-h-[400px] lg:min-h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                                ...
                                <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md rounded-2xl p-4 shadow-lg z-20 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="font-bold text-gray-900">Regulatory Compliant</p>
                                        <p className="text-sm text-gray-500">Secure & protected</p>
                                    </div>
                                </div>
                            </div>
                        </div>
