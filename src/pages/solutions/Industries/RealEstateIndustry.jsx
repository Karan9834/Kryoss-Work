  ...
  const commonFeatures = [
    {
      ...
      desc: "Advanced property filtering based on exact location and radius.",
    },
    {
      icon: MessageSquare,
      title: "Chat with Agents",
      desc: "In-app messaging to discuss properties directly with agents.",
    },
    {
      icon: ImageIcon,
      title: "Image & Media",
      desc: "Upload high-quality images and video tours of the property.",
    },
    {
      icon: CreditCard,
      title: "Pay Property Rent",
      desc: "Integrated payment gateways to easily process rental payments.",
    },
    {
      icon: Star,
      title: "Ratings & Feedback",
      desc: "Verified user reviews and ratings to maintain trust and quality.",
    },
    {
      icon: Bell,
      title: "Alert Notification",
      desc: "Push notification updates on new listings or price changes.",
    },
  ];
  ...
  const advanceFeatures = [
    {
      ...
      desc: "Dedicated pipeline for agents to manage queries and client leads.",
    },
    {
      icon: Zap,
      title: "Property Suggestions",
      desc: "Smart algorithms matching user search history with properties.",
    },
    {
      icon: BarChart,
      title: "Data Analytics",
      desc: "Comprehensive portal for analyzing profits and regional trends.",
    },
    {
      icon: Key,
      title: "Agent Onboarding",
      desc: "Verification and automated onboarding system for new agents.",
    },
    {
      icon: Users,
      title: "Multi-User Roles",
      desc: "Segregated access and permissions for owners, tenants, and admin.",
    },
    {
      icon: RefreshCw,
      title: "Currency Converter",
      desc: "Automatic local currency conversions for international investors.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              >
                Kryoss Softech is an experienced Real Estate App Development
                Company offering innovative solutions for your real estate
                business needs. Enhance work productivity and customer
                satisfaction.
              </motion.p>
            ...
            <div className="w-full lg:w-[55%] relative flex justify-center">
              ...
              >
                ...
                <img
                  ...
                  onError={(e) => {
                    e.target.src = "/SolIndus/RealEstate.png";
                  }}
                />
              </motion.div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <img
                ...
                className="w-full max-w-[420px] lg:max-w-[480px] h-auto object-contain rounded-2xl shadow-xl"
              />
            </motion.div>
            ...
            <div className="w-full lg:w-1/2">
              <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-gray-900 mb-6">
                ...
                <span className="text-orange-500">Seamless System</span>
              </h2>
              <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-600 mb-6 max-w-lg">
                If you are a leading real estate company, an agent, or a small
                agency, our powerful app gives your business lucrative benefits.
              </p>
