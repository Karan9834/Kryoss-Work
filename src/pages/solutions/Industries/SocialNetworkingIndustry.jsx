...
import {
    ...
    MessageCircle, Heart, Share2, Video, Image as ImageIcon,
    Users, Activity, Lock, Settings
} from 'lucide-react';
...
import SocialProductSection from '../../../components/Social-Media-App/ProductSection';
...
const SocialNetworkingIndustry = () => {
    ...
    const panelFeatures = {
        "User App": {
            icon: User,
            image: "/SolIndus/Social2.png",
            features: [
                "Easy Profile Creation", "Real-time Messaging", "Photo/Video Sharing",
                "Like, Share & Comment", "Push Notifications", "Privacy Settings",
                "Explore Feeds", "Follow/Unfollow Modules"
            ]
        },
        "Creator Panel": {
            icon: Star,
            image: "/SolIndus/Social3.png",
            features: [
                "Content Monetization", "Audience Analytics", "Post Scheduling",
                "Engagement Metrics", "Live Streaming", "Collab Spaces",
                "Ad Management", "Payout History"
            ]
        },
        "Admin Panel": {
            icon: Shield,
            image: "/SolIndus/Social4.png",
            features: [
                "User Management", "Content Moderation", "Ad Campaigns",
                "Advanced Analytics", "Revenue Tracking", "Report Management",
                "Role-based Access", "System Settings"
            ]
        }
    };

    const commonFeatures = [
        { icon: MessageCircle, title: "Real-time Messaging", desc: "Instant chat modules supporting text, images, and voice notes." },
        { icon: Heart, title: "Engagement Tools", desc: "Interactive modules allowing users to like, share, and comment." },
        { icon: Bell, title: "Push Notification", desc: "Notify users about new messages, mentions, and updates." },
        { icon: Users, title: "Group & Community", desc: "Enable users to create and manage specialized communities." },
        { icon: Video, title: "Live Streaming", desc: "Broadcast live videos to enhance real-time interactions." },
        { icon: ImageIcon, title: "Media Gallery", desc: "Seamless upload and sharing of high-quality image and video files." }
    ];

    const advanceFeatures = [
        { icon: Zap, title: "Feed Algorithm", desc: "Smart algorithms to show the most relevant posts to unique users." },
        { icon: Lock, title: "End-to-end Encryption", desc: "Ensures user dialogues and personal data are kept secure." },
        { icon: RefreshCw, title: "AR Filters", desc: "Engaging augmented reality tools for stories and posts." },
        { icon: BarChart, title: "In-depth Analytics", desc: "Monitor views, likes, retweets, and other crucial engagement factors." },
        { icon: CreditCard, title: "In-app Purchases", desc: "Secure gateway for digital gifts, premium subscriptions, and badging." },
        { icon: Activity, title: "Content Moderation AI", desc: "Automated AI tracking to flag inappropriate content quickly." }
    ];
                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                Social Media <br /> <span className="text-[30px] md:text-[48px] lg:text-[60px] font-bold leading-[1.2] tracking-[-0.02em] text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500">App Development</span>
                            </motion.h1>
                            ...
                            >
                                Launch a white-label social media platform. At Kryoss, we develop social media apps that engage your audience and keep them entertained for hours.
                            </motion.p>
                        ...
                        <div className="w-full lg:w-[55%] relative flex justify-center">
                            ...
                            >
                                ...
                                <img
                                    src="/SolIndus/Social.png"
                                    alt="Social Media App Development"
                                    width="2048"
                                    height="1365"
                                    className="max-w-full max-h-full object-contain"
                                    onError={(e) => { e.target.src = '/SolIndus/Social.png'; }}
                                />
                            </motion.div>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <img
                                src="/SolIndus/Social1.png"
                                alt="Social App Solution"
                                width="2048"
                                height="1365"
                                className="relative w-full rounded-2xl shadow-xl object-cover h-auto"
                                onError={(e) => { e.target.src = '/SolIndus/Social1.png'; }}
                            />
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-semibold mb-1">User Engagement</p>
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-600 mb-6 max-w-lg">
                                At Kryoss, we study the best practices deployed by popular social networks for digital interaction, content consumption, user engagement, and retention.
                            </p>
                            <ul className="space-y-4 mb-8">
                                {[
                                    "Extensive Content Formats Support",
                                    "Multi-Platform Connectivity",
                                    "Live Interaction Enablers",
                                    "High Retention UI/UX"
                                ].map((item, i) => (
