      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col justify-center">
          ...
          <ul className="space-y-3">
            {[
              "Manage admins and configure department settings",
              "Create roles and assign permissions",
              "Approve leaves and track staff attendance",
              "Monitor income, expenses, and financial performance",
              "Get a complete overview of patients and staff",
              "Access logs and activity tracking",
              "View detailed reports and transaction records",
