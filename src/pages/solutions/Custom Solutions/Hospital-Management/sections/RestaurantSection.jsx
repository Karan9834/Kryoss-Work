    ...
    <section className="w-full bg-white py-16 md:py-20 font-['Inter']">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-[1.875rem] md:text-[2.25rem] font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent mb-5 leading-snug">
            Custom HMS Software Development
          </h2>

          {/* DESCRIPTION - Simple with a span highlight somewhere */}
          <p className="text-[0.875rem] md:text-[1rem] font-normal text-gray-700 leading-relaxed mb-5">
          ...
          <p className="text-[0.875rem] md:text-[1rem] font-normal text-gray-700 leading-relaxed">
