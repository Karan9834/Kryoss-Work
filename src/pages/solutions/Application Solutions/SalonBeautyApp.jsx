...
const SalonBeautyApp = () => {
    ...
    const panelFeatures = {
        "Customer App": {
            icon: Users, image: "/SolAps/salonapp2.png",
            features: [
        ...
        "Provider App": {
            icon: Scissors, image: "/SolAps/salonapp3.png",
            features: [
        ...
        "Salon App": {
            icon: Store, image: "/SolAps/salonapp4.png",
            features: [
        ...
        "Admin Panel": {
            icon: Shield, image: "/SolAps/salonapp5.png",
            features: [
                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                Salon & Beauty <br /> <span className="text-[30px] md:text-[48px] lg:text-[60px] font-bold leading-[1.2] tracking-[-0.02em] text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-pink-500">App Development</span>
                            </motion.h1>
                            ...
                            >
                                Build your salon & beauty solution with us and be ahead of the pack. Empower your business platform with our lightning-fast mobile infrastructure.
                            </motion.p>
                            ...
                            >
                                <button className="text-[16px] font-semibold tracking-[0.01em] normal-case group px-8 py-4 bg-gray-900 text-white rounded-full hover:bg-rose-500 transition-all duration-300 flex items-center justify-center gap-2" onClick={() => document.getElementById('product-section')?.scrollIntoView({ behavior: 'smooth' })}>
                                    Start Exploring
                        ...
                        <div className="w-full lg:w-[55%] relative flex justify-center">
                            ...
                            >
                                ...
                                <img
                                    ...
                                    onError={(e) => { e.target.src = '/SolAps/salonapp1.png'; }}
                                />
                            </motion.div>
                        </div>
                    </div>
                        ...
                        <div ref={leftRef} className="grid grid-cols-2 gap-3 min-h-[400px]">
                            <div className="space-y-3">
                                {panelFeatures[activeTab].features.slice(0, 2).map((item, idx) => (
                                    <div
                                        key={idx}
                                        className="group bg-white p-3 rounded-xl border-2 border-rose-200 hover:border-rose-500 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 cursor-pointer flex items-start"
                                    >
                                        <div className="flex gap-2 w-full items-start">
                                            <CheckCircle className="w-5 h-5 text-rose-500 mt-0.5 group-hover:scale-110 transition-transform flex-shrink-0" />
                                            <div>
                                                <h4 className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-slate-800 group-hover:text-rose-600 transition-colors">
                                                    {item}
                                                </h4>
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-slate-900 mb-6 font-display">
                            Platform <span className="text-rose-600">Capabilities</span>
                        </h2>
                        <div className="flex justify-center gap-4 mt-8 bg-white p-2 rounded-2xl w-max mx-auto border border-slate-200 shadow-sm backdrop-blur-sm">
                            <button
                                ...
                                className={`px-8 py-3 rounded-xl font-semibold transition-all duration-300 ${activeFeatureTab === "Common" ? "bg-rose-500 text-white shadow-lg" : "text-slate-600 hover:text-rose-600"
                                    }`}
                            >
                                Core Essentials
                            </button>
                            <button
                                ...
                                className={`px-8 py-3 rounded-xl font-semibold transition-all duration-300 ${activeFeatureTab === "Advance" ? "bg-rose-500 text-white shadow-lg" : "text-slate-600 hover:text-rose-600"
                                    }`}
                            >
                                Premium Tools
                            </button>
                        ...
                        >
                            {(activeFeatureTab === "Common" ? commonFeatures : advanceFeatures).map((feature, idx) => (
                                <div key={idx} className="bg-white border border-slate-100 p-8 rounded-[2rem] hover:shadow-2xl transition-all duration-500 group relative overflow-hidden shadow-sm">
                                    <div className="w-14 h-14 bg-rose-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-rose-500 transition-all duration-300">
                                        <feature.icon className="text-rose-600 group-hover:text-white transition-colors" size={28} />
                                    </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-start gap-4">
                                                <div className="w-14 h-14 bg-gradient-to-br from-rose-400 to-pink-500 rounded-xl shadow-lg flex items-center justify-center flex-shrink-0 text-white group-hover/card:scale-110 transition-transform duration-300">
