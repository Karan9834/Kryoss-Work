                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                OTT Platform <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500">App Development</span>
                            </motion.h1>
                            ...
                            >
                                <button className="group px-8 py-4 bg-gray-900 text-white rounded-full font-semibold hover:bg-red-500 transition-all duration-300 flex items-center justify-center gap-2">
                                    Start Exploring
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <button className="px-8 py-4 bg-gray-900 text-white rounded-xl font-semibold hover:bg-red-500 transition-all shadow-md">
                                Request a Demo
                            </button>
                        </div>
                    </div>
                        ...
                        <div ref={leftRef} className="grid grid-cols-2 gap-3 min-h-[400px]">
                            <div className="space-y-3">
                                {panelFeatures[activeTab].features.slice(0, 2).map((item, idx) => (
                                    <div
                                        key={idx}
                                        className="group bg-white p-3 rounded-xl border-2 border-red-200 hover:border-red-500 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 cursor-pointer"
                                    >
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <div className="flex justify-center gap-4 mt-8 bg-blue-900/30 p-2 rounded-2xl w-max mx-auto border border-blue-800/50 backdrop-blur-sm">
                            <button
                                ...
                                className={`px-8 py-3 rounded-xl font-semibold transition-all duration-300 ${activeFeatureTab === "Common" ? "bg-red-500 text-white shadow-lg" : "text-gray-300 hover:text-white"
                                    }`}
                            >
                                Core Essentials
                            </button>
                            <button
                                ...
                                className={`px-8 py-3 rounded-xl font-semibold transition-all duration-300 ${activeFeatureTab === "Advance" ? "bg-red-500 text-white shadow-lg" : "text-gray-300 hover:text-white"
                                    }`}
                            >
                                Premium Tools
                            </button>
                        ...
                        >
                            {(activeFeatureTab === "Common" ? commonFeatures : advanceFeatures).map((feature, idx) => (
                                <div key={idx} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 p-8 rounded-2xl hover:bg-slate-800 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-red-500/30 group">
                                    <div className="w-14 h-14 bg-blue-900/50 rounded-xl flex items-center justify-center mb-6 group-hover:bg-red-500 transition-colors border border-blue-800/50">
            ...
            <section className="py-24 bg-gradient-to-br from-white via-orange-50/30 to-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    ...
                    <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
                        <span className="inline-block px-4 py-1.5 bg-red-100 text-red-600 rounded-full text-sm font-semibold tracking-wide mb-4">
                            Why Choose Us
                        </span>
            ...
            <section className="py-20 bg-gray-50 border-t border-gray-200">
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="text-center mb-16">
                        <p className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">OUR OTT PLATFORM PRODUCTS</p>
                        ...
                        {portfolio.map((item, idx) => (
                            ...
                            >
                                <div className="h-48 relative overflow-hidden">
                                    ...
                                    <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/20 blur-2xl rounded-full" />
                                    <PlaySquare size={40} className="text-red-400 absolute top-6 right-6 opacity-80 group-hover:scale-110 transition-transform duration-500" />
                                ...
                                <div className="p-8 flex flex-col flex-grow">
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-auto">
                                        {item.tags.map(tag => (
                                            <span key={tag} className="px-3 py-1 bg-red-50 text-red-600 text-[10px] font-bold uppercase tracking-wider rounded-md">
                                                {tag}
                                            </span>
                                        ))}
                                    </div>
