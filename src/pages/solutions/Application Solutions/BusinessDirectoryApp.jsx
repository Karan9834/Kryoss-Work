...
const ShoppingCartIcon = () => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-1.4 2.6a2 2 0 002 2.4h10.8a2 2 0 002-2.4L17 13M7 13h10M9 18a1 1 0 100 2 1 1 0 000-2zm6 0a1 1 0 100 2 1 1 0 000-2z"
    />
  </svg>
);
...
const BusinessDirectoryApp = () => {
  ...
  const panelFeatures = {
    "Customer App": {
      icon: Users,
      image: "/SolAps/fooddelivery2.png",
      features: [
    ...
    "Vendor Panel": {
      icon: Store,
      image: "/SolAps/fooddelivery3.png",
      features: [
    ...
    "Admin Panel": {
      icon: Shield,
      image: "/SolAps/fooddelivery4.png",
      features: [
  ...
  const commonFeatures = [
    {
      title: "Social Media",
      icon: Share2,
      desc: "The good or bad reviews by the users can be posted on the social media as linked on the app.",
    },
    {
      title: "Top 10",
      icon: Star,
      desc: "Special listings for most rated and top 10 best-offered product/services.",
    },
    {
      title: "Make payment",
      icon: CreditCard,
      desc: "The users can make payments for using the app services much easily with the multiple payment modes available on the app.",
    },
    {
      title: "Edit reviews",
      icon: Edit,
      desc: "If the customers change their mind about a product or services, they can edit the old reviews or ratings posted by them.",
    },
    {
      title: "Advertise",
      icon: TrendingUp,
      desc: "The companies can also advertise their product/services on the app and generate more leads.",
    },
    {
      title: "Directory",
      icon: List,
      desc: "The users can access the reviews and ratings of the listed companies on the app.",
    },
    {
      title: "Add reactions",
      icon: ThumbsUp,
      desc: "The company can offer the customers to like or even dislike products or services.",
    },
    {
      title: "Notifications",
      icon: Bell,
      desc: "The company and the customers can get notifications on the top ratings, worst reviews and much more.",
    },
  ];
  ...
  const advanceFeatures = [
    {
      ...
      icon: MapPin,
      desc: "Find businesses near your current location with real-time GPS tracking and distance calculation.",
    },
    {
      title: "Multi-City Support",
      icon: Globe,
      desc: "Browse businesses across multiple cities, states, and countries with easy switching.",
    },
    {
      title: "Advanced Filtering",
      icon: Filter,
      desc: "Filter businesses by category, rating, price range, distance, and more for precise results.",
    },
    {
      title: "Business Claiming",
      icon: UserCheck,
      desc: "Allow business owners to claim and manage their listings with verification process.",
    },
    {
      title: "Promoted Listings",
      icon: DollarSign,
      desc: "Premium placement options for businesses to get more visibility and leads.",
    },
    {
      title: "Analytics Dashboard",
      icon: BarChart,
      desc: "Detailed insights on profile views, enquiries, and customer engagement metrics.",
    },
    {
      title: "QR Code Check-in",
      icon: Radio,
      desc: "Generate QR codes for businesses to allow customers to check-in and leave reviews.",
    },
    {
      title: "Multi-Device Sync",
      icon: Tablet,
      desc: "Sync user data across mobile, tablet, and web platforms for seamless experience.",
    },
  ];
  ...
  const portfolio = [
    {
      title: "CWJobs",
      description:
        "CWJobs.co.uk is a market leader in specialist IT recruitment, attracting around 500,000 IT professionals to its site.",
      tags: ["Jobs", "Recruitment", "IT"],
      image: "https://images.unsplash.com/photo-1521791136064-7986c2920216",
    },
    {
      title: "Borzo",
      description:
        "Completely hassle-free. No registration fee. No extra charges. Get your deliveries done, cheap and fast.",
    ...
    },
    {
      title: "Hotelcareer",
      description:
        "Staff wanted! Are you a receptionist, a waiter, a chef de partie, a pastry chef, or any hospitality enthusiast?",
  ...
  const solutions = [
    {
      ...
      icon: Settings,
      desc: "Our Script is flexible enough to meet the specific needs of the Clients.",
    },
    {
      title: "Linux Server Installation",
      icon: Server,
      desc: "Web Panels will work smoothly in open source Linux Servers.",
    },
    {
      title: "Payments",
      icon: CreditCard,
      desc: "Our Scripts support API with easy Installations of new ones.",
    },
    {
      title: "Technical Support",
      icon: Headphones,
      desc: "We provide Free Support and handle everything till launch.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              >
                Build your business directory solution with us and be ahead of
                the pack. Empower your business platform with our lightning-fast
              ...
              >
                <button
                  className="text-[16px] font-semibold tracking-[0.01em] normal-case group px-8 py-4 bg-gray-900 text-white rounded-full hover:bg-violet-500 transition-all duration-300 flex items-center justify-center gap-2"
                  onClick={() =>
                    document
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div className="relative w-full max-w-md mx-auto lg:max-w-full">
                <img
                  ...
                  onError={(e) => {
                    e.target.src = "/SolAps/fooddelivery1.png";
                  }}
                />
              </div>
            </motion.div>
            ...
            <div className="w-full lg:w-1/2">
              <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-gray-900 mb-6">
                Complete multi-panel{" "}
                <span className="text-violet-500">Seamless System</span>
              </h2>
              <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-600 mb-6 max-w-lg">
                Kryoss Softech is a leading one-stop solution that provides
                impressive features and turnkey solutions using friendly
                services at affordable prices to give an edge to the
                competitors.
              </p>
              ...
              <Link
                to="/company/contact"
                className="px-8 py-4 bg-gray-900 text-white rounded-xl font-semibold hover:bg-violet-500 transition-all shadow-md"
              >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-slate-900">
              <span className="text-[30px] lg:text-[36px] font-bold leading-[1.2] bg-gradient-to-r from-violet-600 to-slate-800 bg-clip-text text-transparent">
                Must-Have
              </span>{" "}
              ...
              <div className="space-y-3">
                {panelFeatures[activeTab].features
                  ...
                  .map((item, idx) => (
                    <div
                      key={idx}
                      className="group bg-white p-3 rounded-xl border-2 border-violet-200 hover:border-violet-500 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 cursor-pointer flex items-start"
                    >
                      <div className="flex gap-2 w-full items-start">
                        <CheckCircle className="w-5 h-5 text-violet-500 mt-0.5 group-hover:scale-110 transition-transform flex-shrink-0" />
                        <div>
                          <h4 className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-slate-800 group-hover:text-violet-600 transition-colors">
                            {item}
                          </h4>
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-slate-900 mb-6 font-display">
              Platform <span className="text-violet-600">Capabilities</span>
            </h2>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {(activeFeatureTab === "Common"
                ...
                >
                  <div className="w-14 h-14 bg-violet-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-violet-500 transition-all duration-300">
                    <feature.icon
      ...
      <section className="py-24 bg-gradient-to-br from-white via-orange-50/30 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
            <span className="text-[12px] font-medium tracking-[0.05em] uppercase inline-block px-4 py-1.5 bg-violet-100 text-violet-600 rounded-full mb-4">
              Why Choose Us
            </span>
            <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-gray-900 mb-6">
              Tailored to your{" "}
              <span className="text-violet-500 relative inline-block">
                unique business
                <svg
                  className="absolute -bottom-2 left-0 w-full h-3 text-violet-200"
                  viewBox="0 0 200 12"
                  fill="currentColor"
                >
                  <path
          ...
          <div className="flex flex-col lg:flex-row gap-12 xl:gap-20 items-center">
            {/* Left Image Section - Clean, no container */}
