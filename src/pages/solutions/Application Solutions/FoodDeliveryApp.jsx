...
const FoodDeliveryApp = () => {
    ...
    const panelFeatures = {
        "Customer App": {
            icon: Users, image: "/images/customer-app.jpg",
            features: [
        ...
        "Vendor App": {
            icon: Store, image: "/images/vendor-app.jpg",
            features: [
        ...
        "Admin Panel": {
            icon: Shield, image: "/images/admin-food.jpg",
            features: [
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10 py-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                Create Your Own <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500">Food Order & Delivery Platform</span>
                            </motion.h1>
                            ...
                            >
                                Here is the best solution which helps you to start your business. Kryoss offers a highly interactive online food delivery app.
                            </motion.p>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-semibold mb-1">Orders Completed</p>
                        ...
                        <div className="w-full lg:w-1/2">
                            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                                Melange of well-versed and <span className="text-orange-500">proficient developers</span>
                            </h2>
                            <p className="text-gray-600 mb-6 text-base font-semibold leading-relaxed max-w-lg">
                                Our team has years of experience in food delivery app development, delivering customized solutions.
                            </p>
                            <ul className="space-y-4 mb-8">
                                    ...
                                    <li key={0} className="flex items-center gap-3">
                                        ...
                                        <span className="text-gray-700 font-medium">Multi-Platform (iOS, Android)</span>
                                    </li>
                                    ...
                                    <li key={1} className="flex items-center gap-3">
                                        ...
                                        <span className="text-gray-700 font-medium">Extensive Restaurant Features</span>
                                    </li>
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                >
                                    ...
                                    <div className="w-full lg:w-2/3">
                                        ...
                                        <button className="mt-10 px-6 py-3 bg-orange-100 text-orange-500 font-semibold rounded-lg hover:bg-orange-100 transition-colors flex items-center gap-2">
            ...
            <section className="py-20 bg-gray-50 border-t border-gray-200">
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="text-center mb-16">
                        <p className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-2">OUR FOOD PRODUCTS</p>
                            ...
                            >
                                ...
                                <div className="p-8 flex flex-col flex-grow">
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-auto">
                                        {item.tags.map(tag => (
                                            <span key={tag} className="px-3 py-1 bg-orange-100 text-orange-500 text-[10px] font-bold uppercase tracking-wider rounded-md">
                                                {tag}
                                            </span>
                                        ))}
                                    </div>
