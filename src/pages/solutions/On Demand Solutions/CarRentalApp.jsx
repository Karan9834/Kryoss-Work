                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                Car Rental App <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-700 to-slate-900">Development</span>
                            </motion.h1>
                            ...
                            >
                                <button className="group px-8 py-4 bg-gray-900 text-white rounded-full font-semibold hover:bg-slate-700 transition-all duration-300 flex items-center justify-center gap-2">
                                    Start Building
                        ...
                        >
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-semibold mb-1">Fleet Management</p>
            ...
            <section className="py-24 bg-gradient-to-br from-white via-slate-50/50 to-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
                        <span className="inline-block px-4 py-1.5 bg-slate-100 text-slate-800 rounded-full text-sm font-semibold tracking-wide mb-4">
                            Premium Support
                        </span>
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 xl:gap-20 items-stretch">
                        ...
                        <div className="w-full lg:w-2/5 relative group">
                            <div className="relative h-full min-h-[400px] lg:min-h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                                ...
                                <img
                                    src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=compress&cs=tinysrgb&w=1600"
                ...
                <PlusCircle className="w-5 h-5 text-white" />
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Flexible script options</p>
                                    </div>
                                </div>
                            </div>
                        </div>
