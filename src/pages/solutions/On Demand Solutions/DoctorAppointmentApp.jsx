...
import {
    ChevronRight, CheckCircle, Smartphone, User, Shield, Stethoscope, Video, Calendar,
    MapPin, CreditCard, MessageSquare, Star, Bell, History, ArrowRight, Activity, PlusCircle,
    Server, Code, Database, Clock, Upload, Users, Headphones, Settings, Cross
} from 'lucide-react';
...
const DoctorAppointmentApp = () => {
    ...
    const panelFeatures = {
        ...
        "Doctor Panel": {
            ...
            features: [
                ...
                "Manage Prescriptions", "In-app consultations"
            ]
        },
        "Admin Panel": {
            icon: Shield,
            ...
            features: [
                ...
                "Track Appointments", "Record Video Calls"
            ]
        }
    };

    const commonFeatures = [
        { icon: User, title: "Easy Login", desc: "The patients can easily log in to the Scheduling app and create a profile by adding details." },
        { icon: MapPin, title: "Search Nearby Doctors", desc: "The patients can search for nearby doctors in their locality based on their speciality." },
        { icon: Calendar, title: "Book/schedule appointments", desc: "The patients can book or schedule an appointment with the Doctor easily through the app." },
        { icon: Activity, title: "Schedule House calls", desc: "The patients can also ask or schedule a virtual call for online consultations." },
        { icon: MessageSquare, title: "In-App Chat", desc: "In-App chat facilitates communication of medical problems by patients and prescriptions by doctors." },
        { icon: Upload, title: "Upload Medical Reports", desc: "The patients can upload their medical reports, treatment histories on the app for future reference." },
        { icon: Star, title: "Review", desc: "The patients can rate their doctor consultation experiences and give reviews." },
        { icon: Bell, title: "Notifications", desc: "The app automatically sends email and text reminders to patients after booking appointments." }
    ];
    ...
    const advanceFeatures = [
        ...
        { icon: CreditCard, title: "Online Payment", desc: "The Doctor Appointment Booking App offers users to pay online via secure payment integration." },
        { icon: Calendar, title: "Easy Booking", desc: "Patients can easily book appointments, with only one or two taps on the screen." }
    ];
    ...
    return (
        <div className="w-full bg-white relative font-sans overflow-hidden">
                ...
                <div className="max-w-6xl mx-auto px-4 lg:px-6 relative z-10 py-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="w-full lg:w-1/2 text-center lg:text-left">
                            ...
                            >
                                Doctor appointment app development is for healthcare entrepreneurs, doctors, clinics and healthcare professionals to work efficiently and effectively in this digital age. Ensure instant connection between doctors and patients to get medicine prescriptions from home.
                            </motion.p>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <img
                                ...
                                alt="Doctor Appointment App Solution"
                                width="2048"
                                height="1365"
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500 font-semibold mb-1">Total Appointments</p>
                        ...
                        <div className="w-full lg:w-1/2">
                            <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-gray-900 mb-6">
                                Integrated <span className="text-blue-600">Healthcare Solution</span>
                            </h2>
                            <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-600 mb-6 max-w-lg">
                                We provide a budget-friendly and easy-to-use mobile application that ensures a rich user experience. It's fully customizable with new telemedicine features like video-calling, notifications, and report sharing.
                            </p>
                            <ul className="space-y-4 mb-8">
                                {[
                                    "Patient, Doctor & Admin Panels",
                                    "OPD & Online Video Consultations",
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-sky-50/40 py-20 px-6">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-slate-900">
                            ...
                            Features for Doctor Booking App
                        </h2>
                        <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-slate-500 mt-4 max-w-2xl mx-auto">
                            Complete healthcare solution with patient, doctor and admin panels
                        </p>
                                ...
                                {panelFeatures[activeTab].features.slice(0, 2).map((item, idx) => (
                                    <div key={idx} className="group bg-white p-3 rounded-xl border-2 border-blue-200 hover:border-blue-500 hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 cursor-pointer flex items-start">
                                        <div className="flex gap-2 w-full items-start">
                                            ...
                                            <div>
                                                <h4 className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-slate-800 group-hover:text-blue-600 transition-colors">{item}</h4>
                                            </div>
                                        </div>
                                    </div>
                                ))}
            ...
            {/* 5. Stats Section */}
            <section className="py-20 bg-[#EFF6FF] relative">
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                ...
                <div className="container mx-auto px-4 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
                        ...
                        <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-500 max-w-2xl mx-auto">
                            Our solution guarantees performance, stability, and lifetime value packed with seamless integrations for healthcare business.
                        </p>
                    </div>
                        ...
                        <div className="w-full lg:w-2/5 relative group">
                            <div className="relative h-full min-h-[400px] lg:min-h-[500px] rounded-3xl overflow-hidden shadow-2xl">
                                ...
                                <img
                                    ...
                                    alt="Doctor appointment app support"
                                ...
                                <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md rounded-2xl p-4 shadow-lg z-20 flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="font-bold text-gray-900">Customized Healthcare Solutions</p>
                                        <p className="text-sm text-gray-500">Flexible telehealth platform</p>
                                    </div>
                                </div>
                            </div>
                        </div>
