...
const VideoConfApp = () => {
  ...
  const commonFeatures = [
    {
      icon: MessageSquare,
      title: "Group Chat",
      desc: "Group chat option for users to share media, audio messages, and communicate in groups.",
    },
    {
      icon: Lock,
      title: "Security & Privacy",
      desc: "Option to make your profile public or private to keep your data secure at all times.",
    },
    {
      icon: Video,
      title: "Video Calling",
      desc: "Users can easily make HD video calls to families, friends and teams securely.",
    },
    {
      icon: UserPlus,
      title: "Social Integrations",
      desc: "Users can easily connect their social accounts to multimedia sharing and much more.",
    },
    {
      icon: FileText,
      title: "Multimedia Sharing",
      desc: "Various types of multimedia files can be shared like pictures, audio files, contacts & videos.",
    },
    {
      icon: Database,
      title: "Backup & Storage",
      desc: "Backup option so that chats and multimedia can be recovered whenever required.",
    },
    {
      icon: MapPin,
      title: "Location Sharing",
      desc: "Allow users to share their live location by sending and receiving messages.",
    },
    {
      icon: Bell,
      title: "Notifications",
      desc: "Built-in notifications system that allows users to see important messages at the same time.",
    },
  ];
  ...
  const advanceFeatures = [
    {
      ...
      desc: "Military-grade encryption ensuring all meetings and communications remain private and secure.",
    },
    {
      icon: Monitor,
      title: "Virtual Background",
      desc: "Replace or blur your background for a professional look during video conferences.",
    },
    {
      icon: FileText,
      title: "Q&A Sessions",
      desc: "Structured Q&A module allowing participants to submit and vote on questions live.",
    },
    {
      icon: BarChart,
      title: "Public Polls",
      desc: "Engage audience with real-time polls and gather instant feedback during meetings.",
    },
    {
      icon: UserCheck,
      title: "Hand-Raising",
      desc: "Participants can raise virtual hands to signal they want to speak or ask questions.",
    },
    {
      icon: RefreshCw,
      title: "Report Generation",
      desc: "Comprehensive analytics and meeting reports for enterprise performance tracking.",
    },
  ];
  ...
  const solutions = [
    {
      ...
      desc: "Flexible scripts to meet specific client needs and branding requirements.",
    },
    {
      icon: CheckCircle,
      title: "Bug Support",
      desc: "Report issues and get free support/updates for the first year after launch.",
    },
    {
      icon: Shield,
      title: "Lifetime License",
      desc: "One-off payment for lifetime software usage and domain license.",
    },
    {
      icon: Server,
      title: "Linux Installation",
      desc: "Smooth configuration on open-source Linux servers by our expert technical team.",
    },
    {
      icon: Database,
      title: "Open Source DB",
      desc: "Secure MySQL database usage with minimal annual renewal costs.",
    },
    {
      icon: CreditCard,
      title: "Global Payments",
      desc: "Support for international payment gateways and easy API integration.",
    },
    {
      icon: Headphones,
      title: "Technical Support",
      desc: "One year free support handling everything until your platform is launched.",
    },
    {
      icon: Code,
      title: "Open Source Code",
      desc: "100% open source code allowing for full-scale customization as needed.",
    },
  ];
  ...
  return (
    <div className="w-full bg-white relative font-sans overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              >
                ...
                <span className="text-sm font-semibold text-gray-700">
                  On-Demand Video Conferencing Solution
                </span>
              </motion.div>
              ...
              >
                Make remote work easy and smoother for large enterprises,
                organizations, and students while earning great profits with our
              ...
              >
                <button
                  className="text-[16px] font-semibold tracking-[0.01em] normal-case group px-8 py-4 bg-gray-900 text-white rounded-full hover:bg-indigo-600 transition-all duration-300 flex items-center justify-center gap-2"
                  onClick={() =>
                    document
            ...
            <div className="w-full lg:w-[55%] relative flex justify-end">
              <motion.div
                ...
                transition={{ delay: 0.4, duration: 0.8 }}
                className="relative z-10 w-[120%] lg:w-[135%] -mr-10 lg:-mr-24"
              >
                {/* Glow Effect */}
                <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 to-violet-500/20 rounded-3xl blur-3xl rotate-3" />
      ...
      {/* 2. Intro Section - Clean without gray container */}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-gray-600 mb-6 max-w-lg">
                Kryoss Softech is a prominent company with 5+ years of expertise
                in the IT sector and video conferencing app development. We are
                associated with many small and big businesses looking for a
                reliable video conferencing app development company with years
                of experience.
              </p>
              ...
              <Link
                to="/company/contact"
                className="px-8 py-4 bg-gray-900 text-white rounded-xl font-semibold hover:bg-indigo-600 transition-all shadow-md"
              >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-slate-500 mt-4 max-w-2xl mx-auto">
              Complete video conferencing solution with user, admin and advanced
              features
            </p>
          ...
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8 items-start">
            ...
            <div className="flex justify-center">
              <img
                ...
                onError={(e) => {
                  e.target.src =
                    "https://images.pexels.com/photos/5082567/pexels-photo-5082567.jpeg?auto=compress&cs=tinysrgb&w=800";
                }}
              />
            </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {(activeFeatureTab === "Common"
                ...
                <div
                  key={idx}
                  className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 p-8 rounded-2xl hover:bg-slate-800 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:border-indigo-500/30 group"
                >
                  ...
                  <h3 className="text-[14px] lg:text-[16px] font-normal leading-[1.6] text-white mb-3">
                    {feature.title}
                  </h3>
                  <p className="text-indigo-200/70 font-light leading-relaxed">
                    {feature.desc}
                  </p>
                </div>
              ))}
      ...
      {/* 5. Our Solution Features - Clean without image container */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {solutions.map((sol, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="group/card bg-white rounded-2xl p-6 shadow-md hover:shadow-xl border border-gray-100 hover:border-indigo-200 transition-all duration-300 hover:-translate-y-1"
                    >
      ...
      <OurWork
        theme={{ primary: "text-indigo-600", accent: "bg-indigo-600" }}
      />
