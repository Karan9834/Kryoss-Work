...
const ExchangeApps = () => {
    ...
    return (
        <div className="w-full bg-white relative font-sans overflow-hidden">
            ...
            >
                ...
                >
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
                        Exchange <span className="text-orange-500">Works</span>
                    </h1>
                    <p className="text-[16px] md:text-[18px] font-normal leading-[1.6] max-w-[29rem] mx-auto text-gray-200">
                        Industry-leading digital asset and derivatives trading platform solutions for Bitcoin, Ethereum, and more.
                    </p>
                </motion.div>
            </section>

            {/* 2. Breadcrumb - REMOVED */}
            ...
            <section className="pt-12 md:pt-16 bg-white relative z-10 w-full mb-16">
                <div className="container mx-auto px-4 lg:px-8">
                    ...
                    <div className="text-center mb-12">
                        ...
                        >
                            Our <span className="text-orange-500">Exchange</span> Portfolio
                        </motion.h2>
                                    ...
                                    <div key={index} className={`w-full py-16 lg:py-24 ${isEven ? 'bg-white' : 'bg-orange-50'}`}>
                                        <div className={`container mx-auto px-4 lg:px-8 flex flex-col lg:flex-row items-center gap-12 lg:gap-20 ${!isEven ? 'lg:flex-row-reverse' : ''}`}>
                                            ...
                                            <div className="w-full lg:w-1/2 flex flex-col justify-center z-20">
                                                {/* Project Title - Updated: changed from font-extrabold to font-bold */}
                                                <h3
                                                ...
                                                <div 
                                                    className="text-gray-600 leading-relaxed mb-8 text-lg font-normal prose"
            ...
            {/* 4. Stats Counter - Updated: changed from font-extrabold to font-bold */}
