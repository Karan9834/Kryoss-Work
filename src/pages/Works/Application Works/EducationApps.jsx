    ...
    return (
        <div className="w-full bg-white relative font-sans overflow-hidden">
            <section
                ...
                style={{
                    backgroundImage: "linear-gradient(to right, rgba(0,0,0,0.7), rgba(0,0,0,0.4)), url('https://kryosssoftech.org/icons/banner/education.png')",
            ...
            >
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative z-10 container mx-auto px-4">
                    <h1 className="text-[30px] md:text-[48px] lg:text-[60px] font-bold leading-[1.2] tracking-[-0.02em] mb-6">Education <span className="text-orange-500">Applications</span></h1>
                    <p className="text-[16px] md:text-[18px] font-normal leading-[1.6] max-w-[29rem] mx-auto text-gray-200">
                        Transformative education applications building the future of learning and skill development.
                    </p>
                </motion.div>
            </section>
            ...
            <section className="bg-gray-100/80 py-4 border-b border-gray-200 backdrop-blur-md sticky top-0 z-40 shadow-sm">
                <div className="container mx-auto px-4 flex flex-wrap items-center text-sm md:text-base font-semibold text-gray-600">
                    ...
                    <span className="text-orange-500">Education Applications</span>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    <div className="text-center mb-12">
                        <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-[30px] lg:text-[36px] font-bold leading-[1.2] text-black mb-4">
                            Our <span className="text-orange-500">Education</span> Portfolio
                        </motion.h2>
                        ...
                        <motion.div key={activeTab} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.4 }} className="flex flex-col w-full">
                            ...
                            {(!sectionsData[activeTab] || sectionsData[activeTab].length === 0) && (
                                <div className="w-full py-20 flex flex-col items-center justify-center text-center">
                                    ...
                                    <p className="text-gray-500 max-w-md">We are currently curating our best Education works. Check back later!</p>
                                </div>
                            )}
                        </motion.div>
                    </AnimatePresence>
