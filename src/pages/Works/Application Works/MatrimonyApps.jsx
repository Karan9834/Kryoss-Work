    ...
    return (
        <div className="w-full bg-white relative font-sans overflow-hidden">
            <section
                ...
                style={{
                    backgroundImage: "linear-gradient(to right, rgba(0,0,0,0.7), rgba(0,0,0,0.4)), url('/Hero/matrimonial.png')",
            ...
            >
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative z-10 container mx-auto px-4">
                    <h1 className="text-[30px] md:text-[48px] lg:text-[60px] font-bold leading-[1.2] tracking-[-0.02em] mb-6">Matrimony <span className="text-orange-500">Applications</span></h1>
