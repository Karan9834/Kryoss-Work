...
const graphicBrandingData = {
    ...
    sections: {
        "Logo Design": [
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo1.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo2.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo3.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo(1).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo(2).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo(3).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo4.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo5.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo6.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo7.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/logo8.png",
        ...
        "Flyers & Posters": [
            ...
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer2.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer3.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer(1).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer(2).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer(3).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer4.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer5.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer6.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer7.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer8.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/flyer9.png"
        ],
        "Landing Pages": [
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page1.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page2.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page 3.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page (1).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page (2).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page (3).png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page 4.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page 5.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page 6.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page 7.png",
            "https://kryosssoftech.org/icons/Graphic-&-Branding-Works/landing page 8.png",
...
const GraphicBranding = () => {
    const [activeTab, setActiveTab] = useState(graphicBrandingData.tabs[0].id);
    ...
    return (
        <div className="w-full bg-white relative font-sans overflow-hidden">
            ...
            >
                ...
                >
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">Graphic & Branding <span className="text-orange-500">Works</span></h1>
                </motion.div>
            </section>
            ...
            <section className="bg-gray-100/80 py-4 border-b border-gray-200 backdrop-blur-md sticky top-0 z-40 shadow-sm">
                <div className="container mx-auto px-4 flex flex-wrap items-center text-sm md:text-base font-semibold text-gray-600">
                    ...
                    <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
                    <span className="text-orange-500">Graphic & Branding Works</span>
                </div>
            </section>
            ...
            <section className="pt-16 md:pt-24 bg-white relative z-10 w-full mb-16">
                <div className="container mx-auto px-4 lg:px-8">
                    ...
                    <div className="flex flex-wrap justify-center gap-6 lg:gap-10 mb-12 px-2 border-b border-gray-200 pb-4">
                        {graphicBrandingData.tabs.map((tab) => (
                            <button
                                key={tab.id}
                            ...
                            >
                                ...
                                {activeTab === tab.id && (
                                    <motion.div
                                        layoutId="activeTabIndicatorBranding"
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                                {graphicBrandingData.sections[activeTab]?.map((imgSrc, index) => (
                                    <motion.div
                                        key={index}
                            ...
                            {(!graphicBrandingData.sections[activeTab] || graphicBrandingData.sections[activeTab].length === 0) && (
