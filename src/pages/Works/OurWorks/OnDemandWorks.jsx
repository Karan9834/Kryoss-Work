...
import img3 from '../../../assets/ondemandworks/3.png';
import img4 from '../../../assets/ondemandworks/4.png';
import img5 from '../../../assets/ondemandworks/5.png';
import img6 from '../../../assets/ondemandworks/6.png';
    ...
    return (
        <div className="w-full bg-white relative font-sans overflow-hidden">
            ...
            >
                ...
                >
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">On-Demand <span className="text-orange-500">Works</span></h1>
            ...
            <section className="bg-gray-100/80 py-4 border-b border-gray-200 backdrop-blur-md sticky top-0 z-40 shadow-sm">
                <div className="container mx-auto px-4 flex flex-wrap items-center text-sm md:text-base font-semibold text-gray-600">
                    ...
                    <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
                    <span className="text-orange-500">On-Demand Products</span>
                </div>
            </section>
                        ...
                        >
                            ...
                            {(!sectionsData[activeTab] || sectionsData[activeTab].length === 0) && (
                                <div className="w-full py-20 flex flex-col items-center justify-center text-center">
                                    ...
                                    <p className="text-gray-500 max-w-md">We are currently curating our best on-demand service works. Check back later!</p>
                                </div>
                            )}
                        </motion.div>
                    </AnimatePresence>
