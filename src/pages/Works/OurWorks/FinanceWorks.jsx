...
import img3 from '../../../assets/FinanceWorks/3.png';
import img4 from '../../../assets/FinanceWorks/4.png';
    ...
    return (
        <div className="w-full bg-white relative font-sans overflow-hidden">
            ...
            >
                ...
                >
                    <h1 className="text-[30px] md:text-[48px] lg:text-[60px] font-bold leading-[1.2] tracking-[-0.02em] mb-6">Finance <span className="text-orange-500">Works</span></h1>
                    <p className="text-[16px] md:text-[18px] font-normal leading-[1.6] max-w-[29rem] mx-auto text-gray-200">
                        Precision-driven financial technology solutions that empower businesses and streamline wealth management.
                    </p>
                </motion.div>
            </section>
            ...
            <section className="bg-gray-100/80 py-4 border-b border-gray-200 backdrop-blur-md sticky top-0 z-40 shadow-sm">
                <div className="container mx-auto px-4 flex flex-wrap items-center text-sm md:text-base font-semibold text-gray-600">
                    ...
                    <ChevronRight className="w-4 h-4 mx-2 text-gray-400" />
                    <span className="text-orange-500">Finance App Works</span>
                </div>
            </section>
            ...
            <section className="pt-16 md:pt-24 bg-white relative z-10 w-full mb-16">
                <div className="container mx-auto px-4 lg:px-8">
                    ...
                    <div className="text-center mb-12">
                        ...
                        >
                            Our <span className="text-orange-500">Finance</span> Portfolio
                        </motion.h2>
                        ...
                        >
                            ...
                            {(!sectionsData[activeTab] || sectionsData[activeTab].length === 0) && (
                                <div className="w-full py-20 flex flex-col items-center justify-center text-center">
                                    ...
                                    <p className="text-gray-500 max-w-md">We are currently curating our best finance works. Check back later!</p>
                                </div>
                            )}
                        </motion.div>
                    </AnimatePresence>
