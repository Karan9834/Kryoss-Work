        ...
        <section className="w-full py-20 bg-gradient-to-r from-blue-500 to-purple-500">
            <div className="max-w-7xl mx-auto px-6 text-center text-white">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold mb-4">
                    Technologies We Use to Build Scalable Blockchain Gaming
                </h2>
                ...
                <p className="max-w-4xl mx-auto text-white/90 mb-12 text-sm md:text-base">
                    ...
                    gaming mechanics, web platforms, and GameFi backend systems. Our technology
                    stack is carefully selected to ensure reliability, fast transactions,
                    seamless smart networks, and long-term scalability.
                </p>
...
export default EneftiTechStack;
