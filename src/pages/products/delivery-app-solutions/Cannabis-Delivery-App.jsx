            ...
            <section className="w-full bg-white py-32 flex items-center">
                ...
                <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 grid-cols-1 items-center gap-20 px-10">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed mb-5">
                            At White Label Fox, we offer a cutting-edge weed delivery app that simplifies operations, connects stakeholders, and ensures seamless delivery. With advanced features and an intuitive interface, your business can attract more customers and build loyalty.
                        </p>
