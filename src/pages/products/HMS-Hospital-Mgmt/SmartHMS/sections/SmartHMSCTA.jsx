        ...
        <section className="py-24 relative overflow-hidden bg-gradient-to-r from-teal-800 via-cyan-900 to-indigo-900 text-white text-center">
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                ...
                <a
                    ...
                    className="inline-flex items-center justify-center gap-2 px-10 py-5 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-cyan-400 hover:to-teal-400 rounded-xl font-bold text-white text-xl transition-all duration-300 shadow-lg hover:shadow-cyan-500/25 hover:-translate-y-1"
                >
                    Live Demo
