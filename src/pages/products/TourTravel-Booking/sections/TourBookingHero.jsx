        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 animate-fadeInLeft">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <a
                ...
                className="px-10 py-4 bg-white/5 text-white border border-white/10 backdrop-blur-md font-bold rounded-full shadow-2xl hover:bg-white/10 transition-all duration-300 flex items-center gap-2 group hover:scale-105"
              >
          ...
          <div className="relative animate-fadeInRight lg:pr-10">
            <div className="relative group">
              ...
              <div className="relative z-10 w-full h-[250px] md:h-[400px] max-w-[700px] mx-auto bg-white/5 rounded-[40px] border-8 border-white/10 shadow-2xl overflow-hidden transition-all duration-700 group-hover:scale-[1.02] flex items-center justify-center">
