...
const faqs = [
    ...
    {
        question: "What are the essential features included in the TikTok Clone App?",
        answer:
    ...
    {
        question: "Does the TikTok Clone App support both Android and iOS platforms?",
        answer:
        ...
        <div className="w-full">
                ...
                <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 items-center gap-16">
                    ...
                    <div className="text-white space-y-6 max-w-xl">
                        ...
                        <p className="text-gray-300 text-lg leading-relaxed">
                            ...
                            clone lets users create and share videos, helping your business tap
                            into the booming entertainment market. Get started in just 5 days
                            and scale your app globally.
                        </p>
                ...
                <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 grid-cols-1 items-center gap-20 px-10">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-lg leading-relaxed mb-5">
                            A TikTok clone app is a ready-to-launch, white-label platform
                            that allows entrepreneurs and businesses to create their own
                            short-video sharing app, similar to TikTok, without writing
                            a single line of code.
                        </p>

                        <p className="text-gray-600 text-lg leading-relaxed mb-5">
                            Our solution comes with advanced tools like real-time video
                            sharing, unlimited filters, interactive audio customization,
                            and more.
                        </p>

                        <p className="text-gray-600 text-lg leading-relaxed">
                            With scalable and customizable features, you can adjust the
                            app to suit changing market demands and user preferences.
                        </p>
            ...
            <section className="w-full bg-gradient-to-r from-[#5a0009] to-[#720012] py-32 flex items-center">
                ...
                <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 grid-cols-1 items-center gap-20 px-10">
                    ...
                    <div className="text-white">
                        ...
                        <h2 className="text-4xl md:text-5xl font-bold mt-6 mb-8 leading-tight">
                            How the <span className="text-pink-400">TikTok Clone App Works</span>
                        </h2>

                        <p className="text-gray-200 mb-10 text-lg max-w-xl">
                            Our TikTok clone app is designed to provide an easy experience
                            for users and business owners to create, share and manage videos.
                        </p>
                        ...
                        <div className="flex gap-5 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300">
                                    The app creates a personalized feed for each user based
                                    on interests and interactions.
                                </p>
                            </div>
                        ...
                        <div className="flex gap-5 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-gray-300">
                                    Creators can monetize through ads, sponsored content,
                                    or direct support.
                                </p>
                            </div>
                        ...
                        <div className="flex gap-5">
                            ...
                            <div>
                                <h4 className="font-semibold text-lg">Admin Control & Analytics</h4>
                                <p className="text-gray-300">
            ...
            <section className="w-full bg-gray-50 py-32">
                ...
                <div className="text-center max-w-5xl mx-auto mb-24 px-4">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold mt-6 leading-tight">
                        Key Features of <span className="text-red-500">Our TikTok Clone App</span>
                    </h2>

                    <p className="text-gray-600 mt-6 text-lg leading-relaxed">
                        Unlock your entertainment platform’s potential with our TikTok clone app.
                        Enjoy real-time video sharing, unlimited filters, and seamless customization
            ...
            <section className="w-full bg-gray-50 py-32">
                ...
                <div className="text-center max-w-5xl mx-auto px-6 mb-20">
                    ...
                    <p className="text-gray-600 mt-6 text-lg leading-relaxed">
                        Manage your TikTok clone app effortlessly with our intuitive admin panel.
                        Designed for ease of use, it gives you full control over user management,
                        content moderation, and performance tracking.
                    </p>
            ...
            <section className="w-full bg-white py-32">
                ...
                <div className="text-center max-w-5xl mx-auto px-6 mb-20">
                    ...
                    <p className="text-gray-600 mt-6 text-lg">
                        Our TikTok clone app is designed to provide an exceptional experience
            ...
            <section className="w-full py-32 text-white bg-gradient-to-r from-[#3b0006] via-[#0a1b22] to-[#02242b]">
                ...
                <div className="text-center max-w-5xl mx-auto px-6 mb-20">
                    ...
                    <p className="text-gray-300 mt-6 text-lg">
                        Maximize your revenue potential with various monetization strategies.
                    </p>
                ...
                <div className="max-w-[1400px] mx-auto grid md:grid-cols-4 gap-10 px-10">
                    ...
                    {monetization.map((item, index) => (
                        ...
                        >
                            ...
                            <p className={`text-base ${item.dark ? "text-gray-300" : "text-gray-600"}`}>
                                {item.desc}
                            </p>
  ...
  flex items-center px-12 md:px-20 overflow-hidden">
                    ...
                    <div className="text-white max-w-xl z-10">
                        ...
                        <p className="text-gray-200 text-lg mb-10">
                            Ready to make your mark in the entertainment industry?
                            With our TikTok clone app, you can launch your business
                            in just 5 days.
                        </p>
            ...
            <section className="w-full bg-[#4b0009] text-white py-32">
                ...
                <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-16 mt-16 px-10 text-base text-gray-200">
                    ...
                    <ul className="space-y-5 list-disc pl-6">
                        <li>
                            Launch your TikTok-like app in just 5 working days, not weeks,
                            so you can start engaging users immediately.
                        </li>

                        <li>
                            Tailor the app to fit your unique business needs, services,
                            and branding, creating a personalized experience.
                        </li>
                    ...
                    <ul className="space-y-5 list-disc pl-6">
                        ...
                        <li>
                            Keep users informed in real time with notifications about
                            uploads, interactions, and updates.
                        </li>

                        <li>
                            Expand your reach effortlessly with built-in multi-currency
            ...
            <section className="w-full py-32 bg-gradient-to-r from-[#d7e4f2] via-[#d7e7d8] to-[#f4e3c9]">
                ...
                <div className="max-w-[1400px] mx-auto px-10 text-center">
                    ...
                    <h2 className="text-4xl font-semibold mt-6 mb-16">
                        Let's Check <span className="text-red-500">What Our Clients Love to Share!</span>
                    </h2>
            ...
            <section className="w-full bg-gray-50 py-32">
                ...
                <div className="text-center mb-20 px-6">
                    ...
                    <h2 className="text-4xl md:text-5xl font-semibold mt-6">
                        Explore Our <span className="text-red-500">On-Demand App Solutions</span>
                    </h2>
