...
import fineDiningAboutImg from "../../../../../assets/finedinningrms-img/finedinningrmsabout.jpg";
import { CheckCircle } from "lucide-react";

const FineDiningAbout = () => {
    return (
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative">
                        <div className="relative w-full h-[440px] rounded-[2.5rem] overflow-hidden shadow-xl">
                            <img src={fineDiningAboutImg} alt="About Fine Dining" className="w-full h-full object-cover" />
                        </div>
...
export default FineDiningAbout;
