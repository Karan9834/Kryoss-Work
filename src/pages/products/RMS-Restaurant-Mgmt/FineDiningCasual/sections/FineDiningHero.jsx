...
import fineDiningHeroImg from "../../../../../assets/finedinningrms-img/finedinningrmshero.jpg";
import { ArrowRight, UtensilsCrossed, Star, Clock } from "lucide-react";

const FineDiningHero = () => {
    return (
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 grid lg:grid-cols-2 gap-16 items-center py-20">
                ...
                <div className="space-y-8">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-amber-700/50 bg-amber-900/20 backdrop-blur-sm">
                        ...
                        <span className="text-amber-300 text-sm font-bold tracking-wide uppercase">Fine Dining & Casual Restaurant Management</span>
                    </div>
                    ...
                    <p className="text-lg text-amber-100/80 max-w-xl leading-relaxed">
                        A premium restaurant management platform designed for fine dining and casual establishments — floor map management, tableside ordering, wine inventory, and guest preference tracking in one elegant system.
                    </p>
                    ...
                    <div className="pt-2">
                        <a
                            href="https://preview.codecanyon.net/item/bhojon-best-restaurant-management-software-with-restaurant-website/full_screen_preview/23525997"
                            target="_blank"
                ...
                <div className="relative flex items-center justify-center">
                    ...
                    <div className="relative z-10 w-full max-w-lg">
                        <div className="w-full h-[380px] rounded-[2.5rem] border border-amber-700/30 overflow-hidden shadow-2xl">
                            <img src={fineDiningHeroImg} alt="Fine Dining Management" className="w-full h-full object-cover" />
                        </div>
