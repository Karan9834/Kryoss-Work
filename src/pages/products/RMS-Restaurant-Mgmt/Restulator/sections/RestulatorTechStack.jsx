...
const techStack = [
    ...
    { name: "Vue.js", img: php }, // Placeholder for Vue
    { name: "Pusher", img: ms100 },
    { name: "MySQL", img: mysql },
    { name: "jQuery", img: androidstudio }, // Placeholder for jQuery
    { name: "HTML 5", img: html5 },
    { name: "CSS 3", img: css3 },
];

const RestulatorTechStack = () => {
    return (
        <section className="w-full py-20 bg-gradient-to-r from-blue-500 to-purple-500">
            <div className="max-w-7xl mx-auto px-6 text-center text-white">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold mb-4">
                    Interactive Technology for Restulator
                </h2>
...
export default RestulatorTechStack;
