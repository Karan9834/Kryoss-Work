...
import { ArrowRight, Activity, ShieldPlus, Zap, BookOpen } from 'lucide-react';
                    ...
                    <div className="flex flex-wrap gap-6 sm:gap-8 py-6 border-t border-white/10">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center text-fuchsia-300 flex-shrink-0">
                                    {stat.icon}
                                </div>
                                <div>
