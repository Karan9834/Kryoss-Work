...
const techStack = [
    { name: "Laravel 10", img: laravel },
    { name: "PHP", img: php },
    { name: "Tailwind CSS", img: bootstrap },
    { name: "Google OAuth", img: ms100 },
    { name: "Vonage API", img: firebase },
    { name: "MySQL", img: mysql },
    { name: "HTML 5", img: html5 },
    { name: "CSS 3", img: css3 },
];

const EventRightTechStack = () => {
    return (
        <section className="w-full py-20 bg-gradient-to-r from-blue-500 to-purple-500">
            <div className="max-w-7xl mx-auto px-6 text-center text-white">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold mb-4">
                    Modern Technology for EventRight Pro
                </h2>
...
export default EventRightTechStack;
