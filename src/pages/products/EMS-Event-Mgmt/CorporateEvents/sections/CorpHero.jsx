...
import corporateEmsHero from "../../../../../assets/corporateems-img/corporateemshero.jpg";
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10 grid lg:grid-cols-2 gap-16 items-center py-20">
                ...
                <div className="space-y-8">
                    ...
                    <p className="text-lg text-indigo-100 max-w-xl leading-relaxed">
                        A fully integrated event management platform built for enterprises — from seamless registrations and sponsor pipelines to real-time analytics and post-event ROI dashboards.
                    </p>
