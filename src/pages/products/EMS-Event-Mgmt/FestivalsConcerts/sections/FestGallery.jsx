        ...
        <section className="py-24 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16 space-y-4">
                    <span className="text-fuchsia-600 font-bold text-sm uppercase tracking-widest block">Dashboard Preview</span>
                    <h2 className="text-3xl lg:text-4xl xl:text-5xl font-semibold text-slate-900">
                        The Festival{" "}
                        <span className="text-transparent bg-clip-text"
                            style={{ backgroundImage: "linear-gradient(90deg, #a21caf, #db2777)" }}>
                            Operations Hub
                        </span>
                    </h2>
                    <p className="text-slate-500 mt-6 max-w-2xl mx-auto text-lg leading-relaxed font-medium">
                        Live crowd maps, cashless transaction views, per-stage attendance, and fan engagement metrics — all in one command center.
                    </p>
                </div>
