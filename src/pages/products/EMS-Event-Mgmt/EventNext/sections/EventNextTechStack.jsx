        ...
        <section className="w-full py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
            <div className="max-w-7xl mx-auto px-6 text-center text-white">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold mb-4">
                    Revolutionary Technology for Event Next
                </h2>
                ...
                <p className="max-w-4xl mx-auto text-white/90 mb-12 text-sm md:text-base">
                    ...
                    multivendor event platforms. Our technology stack is selected to ensure 
                    reliability, fast deployment, and global scalability for Event Next.
                </p>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    {techStack.map((item, index) => (
                        <div
                            key={index}
                            className="group relative flex items-center gap-3 px-6 py-3 bg-white rounded-full shadow-md cursor-pointer hover:scale-105 transition-transform duration-200"
                        >
                            <img
                                src={item.img}
                                alt={item.name}
...
export default EventNextTechStack;
