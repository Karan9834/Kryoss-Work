...
const BetLabTechStack = () => {
    return (
        <section className="w-full py-20 bg-gradient-to-r from-emerald-500 to-teal-600">
            <div className="max-w-7xl mx-auto px-6 text-center text-white">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold mb-4">
                    Technologies We Use for Scalable Betting Environments
                </h2>

                {/* paragraph */}
                <p className="max-w-4xl mx-auto text-white/90 mb-12 text-sm md:text-base">
                    We use modern, scalable, and ultra-secure tech stacks to build high-performance
                    sportsbook platforms. Our core foundations are heavily geared towards rapid odds updates, immense
                    database scale, instant network connectivity, and zero-downtime latency.
                </p>
...
export default BetLabTechStack;
