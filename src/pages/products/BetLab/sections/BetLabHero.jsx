                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8 order-2 lg:order-1">
                        ...
                        <h1 className="text-4xl lg:text-5xl font-bold leading-tight">
                            BetLab <span className="text-emerald-300">Sports Betting</span> Platform
                        </h1>

                        {/* Description */}
                        <p className="text-gray-200 text-lg leading-relaxed max-w-xl">
                            Launch a comprehensive sports betting solution offering robust markets,
                            real-time odds, and seamless wallet integrations. Designed for massive volume
                            and instant bet settlements globally.
                        </p>
                        ...
                        <div className="grid grid-cols-3 gap-6 pt-4">
                            ...
                            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 flex items-center gap-3">
                                <Star size={20} className="text-emerald-300" />
                                <div>
