      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="relative bg-gradient-to-r from-purple-950/50 via-black to-violet-950/50 backdrop-blur-sm border border-purple-500/30 rounded-3xl p-8 md:p-12 lg:p-16 overflow-hidden">
          ...
          <div className="relative text-center max-w-3xl mx-auto">
            ...
            {/* Icon */}
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r from-purple-600 to-violet-600 shadow-lg shadow-purple-500/30 mb-6 animate-pulse flex-wrap gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap gap-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-600 to-violet-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-purple-500/50 hover:scale-105 transform transition-all duration-300 group flex-wrap gap-4"
              >
                <span>Live Demo</span>
