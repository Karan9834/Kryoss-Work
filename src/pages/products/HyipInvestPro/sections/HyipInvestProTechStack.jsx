        ...
        <section className="w-full py-20 bg-gradient-to-r from-blue-600 to-indigo-700">
            <div className="max-w-7xl mx-auto px-6 text-center text-white">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold mb-4">
                    Technologies Ensuring Flawless Financial Security
                </h2>

                {/* paragraph */}
                <p className="max-w-4xl mx-auto text-white/90 mb-12 text-sm md:text-base">
                    We deploy robust and concurrent systems using advanced PHP/Laravel frameworks capable of managing highly
                    financial transactions. Financial ledgers are completely secure across Web, Android, and iOS devices.
                </p>
...
export default HyipInvestProTechStack;
