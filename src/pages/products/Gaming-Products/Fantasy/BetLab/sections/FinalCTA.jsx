  ...
  return (
    <section className="relative w-full py-20 md:py-28 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-cyan-400/20 blur-[140px] rounded-full"></div>
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-blue-400/20 blur-[100px] rounded-full"></div>
      </div>
      ...
      <div className="relative max-w-5xl mx-auto px-6 lg:px-8 text-center z-10">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
          ...
          <span className="text-cyan-300">Betting Platform</span>
        </h2>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <button
            ...
            className="flex items-center gap-2 px-8 py-3.5 bg-white text-blue-600 font-bold rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
          >
