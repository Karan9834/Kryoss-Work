...
const baseProducts = [
    ...
    {
        id: 'others/opensea-clone',
        name: 'Smart NFT - Premier NFT Marketplace',
        categoryId: 'ecommerce',
        type: 'Web Apps',
        description: 'Smart NFT is a comprehensive, state-of-the-art NFT Marketplace solution designed for creators and investors to trade digital assets with unparalleled ease and security. Featuring advanced smart contract integration and a seamless user interface.',
        image: 'https://images.unsplash.com/photo-1642104704074-907c0698cbd9?w=800&q=80',
        features: ['Minting & Listing', 'Bidding System', 'Decentralized Trading', 'Multi-chain Support'],
        badges: ['Popular', 'Crypto'],
    },
    {
        id: 'others/zed-run-clone',
        name: 'Enefti - Next-Gen NFT Gaming',
        categoryId: 'ecommerce',
        type: 'Mobile Apps',
        description: 'Enefti is an industry-leading virtual asset platform that pioneers the future of NFT-based interactive gaming. With customizable digital horses, unique breeding mechanics, and an integrated competitive ecosystem.',
        image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800&q=80',
        features: ['Virtual Horse Racing', 'Unique Breeding', 'AR Integration', 'In-app Marketplace'],
        badges: ['Trending', 'Hot'],
    },
    ...
    {
        id: 'others/gobet',
        name: 'GoBet - All-in-One Sports Betting App',
        categoryId: 'ecommerce',
        type: 'Mobile Apps',
        description: 'GoBet is a comprehensive sports betting solution offering a wide range of sports markets, real-time odds, and a seamless user experience. Designed for high volume and global reach.',
        image: 'https://images.unsplash.com/photo-1518133835878-5a93cc3f89e5?w=800&q=80',
        features: ['Real-time Odds', 'Multi-Sports Support', 'Secure Payments', 'Advanced Analytics'],
        badges: ['Popular', 'New'],
    },
    {
        id: 'others/betpro',
        name: 'BetPro - Exchange & Multi-Market Betting',
        categoryId: 'ecommerce',
        type: 'Mobile Apps',
        description: 'BetPro is a next-generation betting exchange platform that allows users to bet against each other. With its liquid markets, low latency, and robust settlement engine.',
        image: 'https://images.unsplash.com/photo-1541344999736-83eca872f241?w=800&q=80',
        features: ['Betting Exchange', 'Liquidity Pools', 'Fast Settlement', 'Low Latency'],
        badges: ['Trending', 'Professional'],
    },
    {
        id: 'others/forsage-clone',
        name: 'Hyip InvestPro - Premium Investment Platform',
        categoryId: 'crm',
        type: 'SaaS',
        description: 'Hyip InvestPro is a professional, high-yield investment management system designed for scalability and security. It offers automated profit distribution, multi-currency support, and a comprehensive user dashboard.',
        image: 'https://images.unsplash.com/photo-1621416894522-d28236bd2ecf?w=800&q=80',
        features: ['Automated Profit Distribution', 'Multi-currency Support', 'Secure Payments', 'Admin Dashboard'],
        badges: ['New', 'Popular'],
    },
    {
        id: 'others/supersage-clone',
        name: 'MLMPro - Enterprise MLM Solution',
        categoryId: 'crm',
        type: 'SaaS',
        description: 'MLMPro is an advanced multi-level marketing software suite that supports complex matrix, binary, and unilevel plans. Built on a secure architecture, it provides automated commission settlements and real-time genealogy tracking.',
        image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&q=80',
        features: ['Matrix & Binary Plans', 'Automated Commission', 'Genealogy Tracking', 'Scalable Architecture'],
        badges: ['Enterprise', 'Hot'],
    },
    ...
    },
    {
        ...
        image: 'https://images.unsplash.com/flagged/photo-1558954157-aa76c0d246c6?q=80&w=1331&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        badges: ['SaaS'],
        type: 'SaaS'
    },
    // Education
