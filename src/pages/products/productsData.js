...
const baseProducts = [
    ...
    },
    {
        ...
        name: 'Kryoss OpenSea - NFT OpenSea Clone',
        categoryId: 'ecommerce',
        type: 'Web Apps',
        description: 'Decentralized NFT trading platform like OpenSea. Users can create, mint, buy, sell, bid, and list digital collectibles on various blockchains.',
    ...
    },
    {
        ...
        name: 'Kryoss Zed Run - NFT Zed Run Clone',
        categoryId: 'ecommerce',
        type: 'Mobile Apps',
        description: 'Virtual horse racing NFT gaming platform. Custom set of breeds and unique horse designs. Buy, race, and trade digital horses.',
        image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800&q=80',
        features: ['Virtual Horse Racing', 'Unique Breeding', 'AR Integration', 'In-app Marketplace'],
        badges: ['Trending', 'Hot'],
    },
    {
        id: 'others/matka-platform',
        name: 'Kryoss Matka - Satka Matka Betting Platform',
        categoryId: 'ecommerce',
        type: 'Mobile Apps',
        description: 'World-class gaming software for Satta Matka. Lucitive betting opportunities with real-time results and secure payment systems.',
        image: 'https://images.unsplash.com/photo-1596742572447-5790553ef443?w=800&q=80',
        features: ['Real-time Results', 'Multi-Bazar Support', 'Secure Wallet', 'Admin Control'],
        badges: ['Popular', 'Bestseller'],
    },
    {
        id: 'others/ludo-king-clone',
        name: 'Kryoss Ludo King - Real Money Earning',
        categoryId: 'ecommerce',
        type: 'Mobile Apps',
        description: 'Online version of Ludo with a real money twist. Play for fun and earn cash. Highly secure and fair gameplay logic.',
        image: 'https://images.unsplash.com/photo-1611996598533-4b1fba409b01?w=800&q=80',
        features: ['Real Money Rewards', 'Live Tournament', 'Fair Play Logic', 'Instant Payout'],
        badges: ['Trending', 'Hot'],
    },
    {
        id: 'others/forsage-clone',
        name: 'Kryoss Forsage - MLM Forsage Clone',
        categoryId: 'crm',
        type: 'SaaS',
        description: 'Decentralized Ethereum smart contract based MLM platform. Holistic revenue sources and optimized code for Android/iOS.',
        image: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=800&q=80',
        features: ['Smart Contract MLM', 'Auto-payouts', 'Matrix Marketing', 'Secure & Immutable'],
        badges: ['Crypto', 'New'],
    },
    {
        id: 'others/supersage-clone',
        name: 'Kryoss Supersage - MLM Supersage Clone',
        categoryId: 'crm',
        type: 'SaaS',
        description: 'Top-notch TRON smart contract based MLM script. Handles diverse matrix marketing iterations with self-executing contracts.',
        image: 'https://images.unsplash.com/photo-1621416894522-d28236bd2ecf?w=800&q=80',
        features: ['TRON Smart Contract', 'Advanced Commission', 'Matrix Schemes', 'Ready to Launch'],
