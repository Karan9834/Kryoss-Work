...
import { ArrowRight,
  ...
  ShoppingBag,
  Rocket,
  Shield, MessageCircle } from "lucide-react";
          ...
          <div className="text-center space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 max-w-3xl mx-auto">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-2 justify-center flex-wrap gap-4">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4 flex-wrap gap-4">
              ...
              <a
                ...
                className="group relative inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-orange-500 to-yellow-500 text-white font-semibold rounded-xl shadow-lg hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105 overflow-hidden flex-wrap gap-4"
              >
              ...
              {/* Secondary */}
              <Link to="/company/contact" className="inline-flex items-center justify-center px-8 py-4 border-2 border-white/30 text-white font-semibold rounded-xl hover:bg-white/10 hover:border-white/50 transition-all duration-300 hover:scale-105 flex-wrap gap-4">
