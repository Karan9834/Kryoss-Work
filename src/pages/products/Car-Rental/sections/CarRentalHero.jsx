            ...
            <div className="max-w-7xl mx-auto px-6 py-20 lg:py-28">
                ...
                <div className="grid lg:grid-cols-2 gap-14 items-center">
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Badge */}
                        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 text-sm px-4 py-2 rounded-full w-fit backdrop-blur">
                        ...
                        <p className="text-gray-300 text-lg max-w-xl leading-relaxed">
                            Complete platform for hourly and daily car rentals. Perfect for
                            rental agencies, car dealers, and peer-to-peer car sharing
                            businesses.
                        </p>
