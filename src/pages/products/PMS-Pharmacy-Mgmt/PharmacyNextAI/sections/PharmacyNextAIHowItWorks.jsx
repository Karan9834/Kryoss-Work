...
import { PackageOpen, QrCode, ShieldCheck, CreditCard, ShoppingBag } from "lucide-react";

const events = [
    {
        icon: <PackageOpen size={30} />,
        title: "Smart Procurement",
        desc: "AI predicts stock needs based on seasonal trends and local health data.",
        color: "text-teal-600",
        bg: "bg-teal-50",
        label: "Inventory"
    },
    {
        ...
        desc: "Scan physical prescriptions or receive digital ones directly from doctors.",
        color: "text-cyan-600",
        bg: "bg-cyan-50",
        label: "Intake"
    },
    {
        ...
        title: "AI Validation",
        desc: "System automatically checks for dosage errors and drug interactions.",
    ...
    },
    {
        ...
        desc: "Fast, multi-mode payment processing with automated invoice generation.",
        color: "text-blue-600",
        bg: "bg-blue-50",
        label: "Payment"
    },
    {
        ...
        title: "Omni-Fulfillment",
        desc: "Order ready for pickup or dispatched via integrated delivery partners.",
...
const PharmacyNextAIHowItWorks = () => {
    return (
        <section className="py-12 md:py-16 lg:py-24 bg-white relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-12 lg:mb-24 space-y-4">
                    <span className="text-teal-600 font-bold text-sm uppercase tracking-widest block">Workflow Timeline</span>
                            ...
                            <div key={idx} className="flex flex-col items-center group relative">
                                <div className="mb-6 sm:mb-10 relative">
                                    <div className={`w-20 h-20 sm:w-28 sm:h-28 ${event.bg} rounded-full flex items-center justify-center ${event.color} border-4 border-white shadow-2xl group-hover:scale-110 transition-transform duration-500`}>
                                        {React.cloneElement(event.icon, { size: typeof window !== 'undefined' && window.innerWidth < 640 ? 24 : 30 })}
                                    </div>
                                    <div className="absolute top-[50%] left-[105%] hidden lg:block w-[70px] h-[2px] bg-teal-500 opacity-20 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500" />
            ...
            <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-teal-50 rounded-full blur-[120px] -z-0 opacity-40 animate-pulse" />
...
export default PharmacyNextAIHowItWorks;
