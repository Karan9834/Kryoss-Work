...
const PharmacyNextAICTA = () => {
    return (
        <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden bg-teal-900"
            ...
            <div className="max-w-4xl mx-auto px-6 text-center relative z-10 space-y-8 sm:space-y-10">
                <div className="inline-block px-6 py-2 sm:px-8 sm:py-3 rounded-full bg-teal-800/50 text-teal-300 font-black text-[10px] sm:text-sm uppercase tracking-[0.25em] shadow-inner border border-teal-700">
                ...
                <p className="text-teal-100/70 text-base sm:text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed font-bold tracking-tight px-4">
                    Experience the future of retail pharmacy management today. Fast, secure, and powered by AI.
                </p>
                <div className="pt-4 sm:pt-6">
                    <a
                        ...
                        style={{ background: "linear-gradient(90deg, #0d9488, #4f46e5)", boxShadow: "0 15px 45px rgba(13,148,136,0.3)" }}
                    >
                        Try Live Demo
...
export default PharmacyNextAICTA;
