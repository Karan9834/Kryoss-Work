        ...
        <section className="py-24 bg-[#f5f3ff]">
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <h2 className="text-center text-4xl font-bold text-gray-900">
                    Explore the <span className="text-purple-600">AI Content Generator</span>
                </h2>

                <p className="text-center text-gray-600 max-w-2xl mx-auto mt-4">
                    Take a look at the intuitive interface of our AI-powered content
                    generation platform designed for bloggers, marketers, and creators.
                </p>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-14">
                    ...
                    {images.map((img, index) => (
                        ...
                        >
                            ...
                            <img
                                src={img}
                                alt="AI Content Generator Screenshot"
...
export default AIContentGallery;