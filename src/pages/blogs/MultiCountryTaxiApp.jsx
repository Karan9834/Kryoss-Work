...
import blogImg from "../../assets/blog/Designing a Multi-Country Taxi App Experience for Global Travelers.png";

const MultiCountryTaxiApp = () => {
  return (
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed text-lg">
          <p className="mb-6 text-xl text-gray-600 font-medium italic border-l-4 border-orange-500 pl-6 py-2">
            A deep dive into how we built a cross-border ride-booking solution with localized pricing, multilingual support, and reliable driver networks.
          </p>
          
          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4 text-orange-500">The Challenge</h2>
          <p className="mb-6">
            Building for a global audience requires more than just translation. We had to implement a dynamic localization engine that adjusts pricing models based on local currency, integrates with regional payment providers, and offers real-time support in over 10 languages.
          </p>

          <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4 text-orange-500">The Solution</h2>
          <p className="mb-6">
            Travelers can now move seamlessly between countries using the same familiar interface, with the platform handling all the complexities of local regulations and currency conversions in the background. The result was a 40% increase in cross-border bookings within the first quarter.
          </p>

          <blockquote className="bg-gray-50 p-8 rounded-xl border-l-8 border-orange-500 my-10 font-bold text-gray-800">
            "By focusing on core engineering principles and user-centric design, we helped our client transform from a startup into a serious market contender."
          </blockquote>
        </div>
...
export default MultiCountryTaxiApp;
